...
- Implementação integrada pelo PR #128, após reaplicação limpa sobre a `main` contemporânea.
- Merge canônico: `461f386179a3c904f52793354998c29ff7979dd7`.
- O head combinado `a02b76ae004aa48e3fe2efef01c33c31f1fd267f` passou no `RPG Skill Tree CI` run `33244574779`, incluindo Core tests, JUnit 5, NeoForge GameTests, build, verificação do JAR e dedicated-server smoke; Foundation/Compendium associados também fecharam GREEN.
