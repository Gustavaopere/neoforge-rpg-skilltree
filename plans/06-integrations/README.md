...
Subplanos concluídos:

- `✅-01-adapter-contract.md` — **CONCLUÍDO** pela PR #444. Introduz `SemanticActionId`, `IntegrationCapability`, `IntegrationAdapter`, `IntegrationAdapterFactory` e `IntegrationAdapterRegistry`; provider ausente não instancia adapter, capabilities permanecem provider-neutral, ownership semântico é único e colisões falham fechado. O head final `b03ad5d862baa157ed311d1a5181a7423553ebd5` fechou 25/25 workflows de pull request em `success`; merge na `main`: `f23afcf14adfd5936991487980037f280683fb43`.
- `✅-03-irons-spellbooks.md` — **CONCLUÍDO**. Integra o provider Iron's Spells 'n Spellbooks preservando authority e lifecycle nativos.
- `✅-05-goety-malum-eidolon.md` — **CONCLUÍDO**. Mantém o bloco Goety/Malum/Eidolon no contrato aprovado, incluindo no-op/fail-closed onde não existe hook seguro.
...
Subplanos ainda abertos: `02-epicfight.md`, `04-ars-nouveau.md`, `06-identity-morphs.md`, `07-apothic-attributes.md`, `08-create-ae2-oritech.md` e `09-integration-test-matrix.md`.
