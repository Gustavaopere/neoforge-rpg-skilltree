...
`EclipticSeasons-1.21.1-neoforge-0.15.0-rc-3.jar`
...
A linha atual mantém renderização sazonal e integrações de mundo distante. O stack instalado possui ainda **Ecliptic Seasons: MultiMod Patch 0.32.1**, que adiciona compatibilidades em código, e **Ecliptic Seasons: Bundles 0.18.0.2**, que fornece datapacks/resource packs para conteúdo externo.
Ele não mede a temperatura corporal do jogador: essa função continua pertencendo ao Cold Sweat. A build `0.15.0-rc-3` é a versão NeoForge 1.21.1 instalada; o sufixo `rc-3` descreve a maturidade da release instalada, não dúvida sobre identidade ou presença.
...
`Ecliptic-Seasons-MultiMod-Patch-1.21.1-neoforge-0.32.1.jar`
...
Ele não cria estações novas: traduz o estado sazonal do Ecliptic Seasons para APIs e mecânicas de outros mods. A release instalada é `0.32.1` para NeoForge 1.21.1.

## Ecliptic Seasons: Bundles — 0.18.0.2

`EclipticSeasons-Bundles-0.18.0.2.jar`
...
Portanto Bundles e MultiMod Patch não são duplicatas: um concentra dados/recursos e o outro integra lógica em código. O runtime atual é `0.18.0.2`.
