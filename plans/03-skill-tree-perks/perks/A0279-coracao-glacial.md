...
RPG Skill Tree + SPECIALIST_GATE_RESOLVER_V1 + FUTURE_PROVIDER_CONTRACT DAMAGE_MITIGATION_RESOLVER_V1 + classificadores ICE/COLD_DAMAGE + Cold Sweat 2.4.2 por contratos independentes: BODY_COLD_STATE_V1 (design P-0054) para eventual ADVERSE_COLD_SEVERE e THERMAL_PARCEL_PIPELINE_V1 (design P-0057) para novos parcels térmicos frios. Iron's/Ars e outros providers ICE só alimentam o bucket ICE quando a ação/dano estiver explicitamente classificada; Cold Sweat ModDamageSources.COLD pode mapear para COLD_DAMAGE, nunca para ICE. VERSION-STATUS: P-0054/P-0057 não foram encontrados como APIs runtime na main auditada em 2026-08-29; gatilho térmico e modificação de parcel permanecem fail-closed até adapter real.
...
- **Contratos/capabilities nomeados no registro:** <code>SPECIALIST_GATE_RESOLVER_V1</code>, <code>DAMAGE_MITIGATION_RESOLVER_V1</code>, <code>BODY_COLD_STATE_V1</code>, <code>THERMAL_PARCEL_PIPELINE_V1</code>.
...
- **Capabilities/contracts a provar:** <code>SPECIALIST_GATE_RESOLVER_V1</code>, <code>DAMAGE_MITIGATION_RESOLVER_V1</code>, <code>BODY_COLD_STATE_V1</code>, <code>THERMAL_PARCEL_PIPELINE_V1</code>.
