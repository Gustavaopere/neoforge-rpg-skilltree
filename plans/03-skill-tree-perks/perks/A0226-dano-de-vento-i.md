...
- **Fonte canônica:** [registro A0226 no Catálogo Mestre do Notion](https://app.notion.com/3c569db9f0db818fabb6d17f41005ab7).
...
|---|---|
| Código | A0226 |
| Nome | Dano de Vento I |
| Domínio | ARCANE |
| Árvore | Principal — ARCANE ↔ AGILITY |
| Ramo | Vento — Potência Cinética |
| Camada | 4 |
...
| Dependências Obrigatórias | A0144 Poder Mágico ≥ 2 ranks + Gateway ARCANE ativo + pelo menos 1 node de técnica arcana com ≥1 rank entre A0148, A0149, A0150, A0151, A0152, A0153, A0154 e A0155. |
| Pré-requisitos | A0144 Poder Mágico ≥2 + Gateway ARCANE + ≥1 técnica arcana A0148–A0155. |
| Provider/Mods | SnackPirate's Aeromancy Additions 1.2.8 + Wind's Spellbooks 1.0.5 + Iron's Spells 'n Spellbooks runtime 1.21.1-3.16.3 como framework. Ars Elemental 0.7.10.1 e outros providers só participam quando a ação concreta estiver explicitamente mapeada WIND. ParCool/Epic ParCool/Epic Fight não classificam dano como WIND por movimento; são somente bridges de ação/mobilidade quando um adapter específico assim exigir. |
| Efeito | +3% de dano WIND por rank (máx. +12%) em componentes mágicos WIND diretos elegíveis e atribuídos ao jogador. Vento é termicamente contextual; qualquer parcel térmico só existe quando a ação concreta o declarar explicitamente. |
| Escalonamento | Até 4 ranks; multiplicador da camada WIND direta: ×1,03 / ×1,06 / ×1,09 / ×1,12. Teto próprio de A0226: +12%. |
| Gate | Gateway ARCANE + A0144 ≥2 + ≥1 técnica arcana + componente mágico direto classificado WIND por adapter versionado. Knockback genérico, projétil, entidade aérea, sprint, salto, queda, movimento comum, DoT já derivado e derived_component não são WIND por inferência. |
| Hook | Pipeline canônico: Potência Mágica universal → camada WIND A0226 uma única vez por componente direto → especializações posteriores. Preservar action_id/outcome_id; eventual parcel térmico é processado separadamente. |
| Fallback | Sem classificação WIND explícita e ownership mágico direto confiável, A0226 fica inativa naquela fonte. Não inferir por movimento, velocidade, knockback, launch, projétil, entidade aérea, partículas, ParCool/Epic Fight ou aparência; não converter em dano cinético/físico genérico. |
| Regra | FUNDAMENTO_EXTERIOR: ARCANE/WIND. PP_REGION: ARCANE/WIND. Wind Mastery nasce somente de ações/resultados WIND reais e explicitamente classificados; pular, cair, correr, dodge, vault, knockback ou voar sem atribuição WIND não geram mastery. WIND é distinto de movimento, impacto/knockback e temperatura. A0226 pode compor Gate A da Specialist Wind; Gate B ≥100 PP válidos e terminal correto continuam obrigatórios. |
...
+3% de dano WIND por rank (máx. +12%) em componentes mágicos WIND diretos elegíveis e atribuídos ao jogador. Vento é termicamente contextual; qualquer parcel térmico só existe quando a ação concreta o declarar explicitamente.

### Escalonamento aprovado

Até 4 ranks; multiplicador da camada WIND direta: ×1,03 / ×1,06 / ×1,09 / ×1,12. Teto próprio de A0226: +12%.

### Gate de compra/ativação

Gateway ARCANE + A0144 ≥2 + ≥1 técnica arcana + componente mágico direto classificado WIND por adapter versionado. Knockback genérico, projétil, entidade aérea, sprint, salto, queda, movimento comum, DoT já derivado e derived_component não são WIND por inferência.

### Hook e ordem de execução

Pipeline canônico: Potência Mágica universal → camada WIND A0226 uma única vez por componente direto → especializações posteriores. Preservar action_id/outcome_id; eventual parcel térmico é processado separadamente.

### Fallback sem trocar a identidade

Sem classificação WIND explícita e ownership mágico direto confiável, A0226 fica inativa naquela fonte. Não inferir por movimento, velocidade, knockback, launch, projétil, entidade aérea, partículas, ParCool/Epic Fight ou aparência; não converter em dano cinético/físico genérico.
...
| Item | Decisão |
|---|---|
| Região | Principal — ARCANE ↔ AGILITY / Vento — Potência Cinética |
...
| Dependência semântica completa | A0144 Poder Mágico ≥ 2 ranks + Gateway ARCANE ativo + pelo menos 1 node de técnica arcana com ≥1 rank entre A0148, A0149, A0150, A0151, A0152, A0153, A0154 e A0155. |
| Custo topológico | 1 PP por rank; 4 rank(s); extra 0 |
| Regra de região/PP | FUNDAMENTO_EXTERIOR: ARCANE/WIND. PP_REGION: ARCANE/WIND. Wind Mastery nasce somente de ações/resultados WIND reais e explicitamente classificados; pular, cair, correr, dodge, vault, knockback ou voar sem atribuição WIND não geram mastery. WIND é distinto de movimento, impacto/knockback e temperatura. A0226 pode compor Gate A da Specialist Wind; Gate B ≥100 PP válidos e terminal correto continuam obrigatórios. |
...
SnackPirate's Aeromancy Additions 1.2.8 + Wind's Spellbooks 1.0.5 + Iron's Spells 'n Spellbooks runtime 1.21.1-3.16.3 como framework. Ars Elemental 0.7.10.1 e outros providers só participam quando a ação concreta estiver explicitamente mapeada WIND. ParCool/Epic ParCool/Epic Fight não classificam dano como WIND por movimento; são somente bridges de ação/mobilidade quando um adapter específico assim exigir.
...
| Projeto | Head auditado | Decisão para A0226 | Authority/boundary |
|---|---|---|---|
...
- **Consumidor:** o serviço RPG indicado no Hook; ele aplica somente a contribuição de A0226.
...
- **Fallback normativo:** Sem classificação WIND explícita e ownership mágico direto confiável, A0226 fica inativa naquela fonte. Não inferir por movimento, velocidade, knockback, launch, projétil, entidade aérea, partículas, ParCool/Epic Fight ou aparência; não converter em dano cinético/físico genérico.
...
3. **Escalonamento:** validar cada rank/coeficiente/TTL/cap exato de Até 4 ranks; multiplicador da camada WIND direta: ×1,03 / ×1,06 / ×1,09 / ×1,12. Teto próprio de A0226: +12%..
...
- Página: [A0226 — Dano de Vento I](https://app.notion.com/3c569db9f0db818fabb6d17f41005ab7)
...
**Resultado final do Chat 1 para A0226:** design suficientemente especificado para implementação sem redesign; qualquer capability/dependência ausente mantém a perk ou sua parcela dependente fail-closed.
