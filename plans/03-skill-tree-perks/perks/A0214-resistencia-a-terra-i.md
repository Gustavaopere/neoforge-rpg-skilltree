...
- **Fonte canônica:** [registro A0214 no Catálogo Mestre do Notion](https://app.notion.com/3c569db9f0db8195a0d9dda9579cf322).
...
|---|---|
| Código | A0214 |
| Nome | Resistência a Terra I |
| Domínio | VITALITY |
| Árvore | Principal — VITALITY ↔ MINING/ARCANE |
| Ramo | Terra — Defesa Mineral |
| Camada | 4 |
...
| Dependências Obrigatórias | A0212 Dano de Terra I ≥ 1 rank OU Gateway VITALITY ativo. A0214 é ponte defensiva; a rota defensiva isolada não conta como prova de domínio para Maestria de Terra. |
| Pré-requisitos | A0212 Dano de Terra I ≥1 ou Gateway VITALITY. |
| Provider/Mods | Minecraft/NeoForge + DamageMitigationResolver/RPG_EARTH_RESISTANCE + GTBC's Geomancy Plus runtime 1.1.0-1.21.1 e demais providers apenas quando o componente hostil estiver explicitamente EARTH-classificado + VITALITY canônico. MINING é ponte topológica/semântica, não classificador de dano. |
| Efeito | +3% de Resistência a Terra por rank (máx. +12%) contra componentes EARTH elegíveis. A0214 contribui para um único bucket canônico RPG_EARTH_RESISTANCE; não existe cap defensivo global implícito. |
| Escalonamento | Até 4 ranks; contribuição ao bucket RPG_EARTH_RESISTANCE: +3% / +6% / +9% / +12%. Teto próprio de A0214: 12%. |
| Gate | (A0212 ≥1 OU Gateway VITALITY ativo) + componente de dano legitimamente classificado EARTH. Queda, sufocamento, esmagamento, dano físico pétreo, impacto, ambiente e temperatura não entram por inferência. |
| Hook | DamageMitigationResolver: classificar EARTH uma vez, somar A0214 ao canonical_modifier_id=RPG_EARTH_RESISTANCE e resolver esse bucket uma única vez no componente EARTH antes de compor mitigadores semanticamente distintos. |
| Fallback | Sem classificação EARTH explícita e segura, A0214 fica inativa naquele componente. Não converter em armadura, resistência a impacto/knockback, queda, sufocamento/esmagamento, mineração ou proteção ambiental/geológica. |
| Regra | FUNDAMENTO_EXTERIOR: VITALITY/EARTH_RESISTANCE. PP_REGION: VITALITY_MINING_EARTH_BRIDGE/RESISTANCE. BRIDGE_PP_POLICY: estes PP não contam simultaneamente para thresholds puros de VITALITY, MINING e ARCANE; uma Specialist pode whitelistar no máximo um lado semântico. RPG_EARTH_RESISTANCE é separado de Armor, impacto, knockback, queda, mineração e ambiente. Ponte da Árvore Exterior; não é terminal. |
...
+3% de Resistência a Terra por rank (máx. +12%) contra componentes EARTH elegíveis. A0214 contribui para um único bucket canônico RPG_EARTH_RESISTANCE; não existe cap defensivo global implícito.

### Escalonamento aprovado

Até 4 ranks; contribuição ao bucket RPG_EARTH_RESISTANCE: +3% / +6% / +9% / +12%. Teto próprio de A0214: 12%.

### Gate de compra/ativação

(A0212 ≥1 OU Gateway VITALITY ativo) + componente de dano legitimamente classificado EARTH. Queda, sufocamento, esmagamento, dano físico pétreo, impacto, ambiente e temperatura não entram por inferência.

### Hook e ordem de execução

DamageMitigationResolver: classificar EARTH uma vez, somar A0214 ao canonical_modifier_id=RPG_EARTH_RESISTANCE e resolver esse bucket uma única vez no componente EARTH antes de compor mitigadores semanticamente distintos.

### Fallback sem trocar a identidade

Sem classificação EARTH explícita e segura, A0214 fica inativa naquele componente. Não converter em armadura, resistência a impacto/knockback, queda, sufocamento/esmagamento, mineração ou proteção ambiental/geológica.
...
| Item | Decisão |
|---|---|
| Região | Principal — VITALITY ↔ MINING/ARCANE / Terra — Defesa Mineral |
| Camada e papel | Camada 4; Ponte |
| Pré-requisito visual/estrutural | A0212 Dano de Terra I ≥1 ou Gateway VITALITY. |
| Dependência semântica completa | A0212 Dano de Terra I ≥ 1 rank OU Gateway VITALITY ativo. A0214 é ponte defensiva; a rota defensiva isolada não conta como prova de domínio para Maestria de Terra. |
| Custo topológico | 1 PP por rank; 4 rank(s); extra 0 |
| Regra de região/PP | FUNDAMENTO_EXTERIOR: VITALITY/EARTH_RESISTANCE. PP_REGION: VITALITY_MINING_EARTH_BRIDGE/RESISTANCE. BRIDGE_PP_POLICY: estes PP não contam simultaneamente para thresholds puros de VITALITY, MINING e ARCANE; uma Specialist pode whitelistar no máximo um lado semântico. RPG_EARTH_RESISTANCE é separado de Armor, impacto, knockback, queda, mineração e ambiente. Ponte da Árvore Exterior; não é terminal. |
...
Minecraft/NeoForge + DamageMitigationResolver/RPG_EARTH_RESISTANCE + GTBC's Geomancy Plus runtime 1.1.0-1.21.1 e demais providers apenas quando o componente hostil estiver explicitamente EARTH-classificado + VITALITY canônico. MINING é ponte topológica/semântica, não classificador de dano.
...
| Projeto | Head auditado | Decisão para A0214 | Authority/boundary |
|---|---|---|---|
...
- **Consumidor:** o serviço RPG indicado no Hook; ele aplica somente a contribuição de A0214.
...
- **Fallback normativo:** Sem classificação EARTH explícita e segura, A0214 fica inativa naquele componente. Não converter em armadura, resistência a impacto/knockback, queda, sufocamento/esmagamento, mineração ou proteção ambiental/geológica.
...
3. **Escalonamento:** validar cada rank/coeficiente/TTL/cap exato de Até 4 ranks; contribuição ao bucket RPG_EARTH_RESISTANCE: +3% / +6% / +9% / +12%. Teto próprio de A0214: 12%..
...
- Página: [A0214 — Resistência a Terra I](https://app.notion.com/3c569db9f0db8195a0d9dda9579cf322)
...
**Resultado final do Chat 1 para A0214:** design suficientemente especificado para implementação sem redesign; qualquer capability/dependência ausente mantém a perk ou sua parcela dependente fail-closed.
