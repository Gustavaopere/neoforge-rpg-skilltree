...
- [x] revalidado no CI #2130 para o pipeline/versão exata atuais.
...
- [x] Regressões específicas de provenance + suíte crítica verdes no CI #2130.
- [x] NeoForge GameTests, build, JAR e dedicated-server smoke verdes no CI #2130.
