...
- `AUDITORIA-A0141-A0150.md` — fechamento de design A0141–A0150, incluindo nutrição all-or-nothing, authority MANA por provider, max-mana sem top-up, cast-time provider-native, cooldown reservation→commit e interruption fail-closed.
