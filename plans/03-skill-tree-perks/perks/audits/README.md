...
- `AUDITORIA-A0091-A0100.md` — fechamento de design A0091–A0100, incluindo classificação física governada, guarda fail-closed, redesign provider-native de Tenacidade em `epicfight:stun_armor`, defesa móvel/estacionária e Anti-Crítico unavailable.
