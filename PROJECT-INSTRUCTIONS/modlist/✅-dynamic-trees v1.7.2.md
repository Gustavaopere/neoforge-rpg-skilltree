...
- **Procedência:** modlist física atual de 21/09/2026 — 587 mods incluindo o modloader — confirma `dynamictrees-neoforge-1.21.1-1.7.2.jar` / runtime `1.7.2`, Dynamic Trees Plus `1.3.2`, Addon Lib `0.2.0-BETA03` e os bridges físicos atuais. A versão `1.7.2` permanece a build NeoForge 1.21.1 catalogada.
- **Observações:** Runtime 1.7.2 permanece current para NeoForge 1.21.1. A linha 1.8.0 publicada em 2026 é para Minecraft 26.1.2 e não substitui o runtime do pack. Stack atual de Plus/Addon Lib/bridges continua version-sensitive.
- **Atualização/Status:** REAUDITADO EM 21/09/2026 — lote físico #234: `dynamictrees-neoforge-1.21.1-1.7.2.jar` / runtime `1.7.2` reconfirmados na modlist física atual de 587 mods incluindo o modloader; stack de bridges reconciliado ao snapshot atual.
- **Decisão:** Manter
...
### 21. Evidências
- modlist física atual de 21/09/2026: runtime 1.7.2 e stack de addons/bridges;
