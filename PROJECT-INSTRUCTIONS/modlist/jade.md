...
- **Dependências:** NeoForge 1.21.1. Source exato 15.10.6 foi desenvolvido contra NeoForge 21.1.21. Pack usa 21.1.250. Addons físicos incluem Jade Sable Compat 1.3.0 e MineColonies Jade Crops 1.1.1300; Create Aeronautics está presente e recebe compat melhorada na 15.10.6.
...
- **Observações:** Runtime físico `15.10.6+neoforge` permanece a build correta para Minecraft 1.21.1. Atualizações recentes do projeto são de outras linhas de Minecraft e não substituem esta versão.
- **Procedência:** modlist(1).txt física anexada e reconferida em 25/09/2026 + CurseForge oficial Jade file 8591319 `[NeoForge 1.21.1] 15.10.6`, release de 06/08/2026 + source oficial Snownee/Jade branch 1.21-neoforge e changelog 15.10.5/15.10.6 já auditados. Matriz física atual usa NeoForge 21.1.250.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Jade 15.10.6+neoforge/JAR físico reconfirmado; fluid registry encoding, Create Aeronautics compatibility, render-state regression, addon/provider authority, lifecycle, riscos e testes preservados; loader físico reconciliado para NeoForge 21.1.250.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #347: JAR `Jade-1.21.1-NeoForge-15.10.6.jar`, mod id `jade`, runtime `15.10.6+neoforge`, SHA-1 `88ee316e68900080b017f60c12162e2731924cf8`.
