...
- **Dependências:** Source 3.16.3: GeckoLib, Player Animator, Patchouli, Curios e Iron's Lib; JEI é integração/dev surface. Pack físico: GeckoLib 4.9.2, Player Animator 2.0.4+1.21.1, Patchouli 1.21.1-93-NEOFORGE, Curios 9.5.1+1.21.1, Iron's Lib 2.1.0 e JEI 19.56.0.440.
...
- **Observações:** Core 3.16.3 continua sendo a versão física e upstream atual para Minecraft 1.21.1. Addons do pack permanecem sujeitos à matriz 3.16.2→3.16.3 quando compilados/documentados contra patch anterior.
- **Procedência:** modlist(1).txt física anexada e reconferida em 25/09/2026 + CurseForge oficial file 8680204 `v1.21.1-3.16.3`, release NeoForge 1.21.1 de 18/08/2026 + source oficial branch 1.21 e registries/changelog já auditados. Revalidação física confirmou 3.16.3 e atualizou a matriz do pack para JEI 19.56.0.440.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Iron's Spells 'n Spellbooks 1.21.1-3.16.3/JAR físico reconfirmado; registry base 9 schools/111 spells, mana/cast/recast, equipment/worldgen, fixes 3.16.3, addon boundaries, lifecycle, riscos e testes preservados; matriz física reconciliada com JEI 19.56.0.440.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #342: JAR `irons_spellbooks-1.21.1-3.16.3.jar`, mod id `irons_spellbooks`, runtime `1.21.1-3.16.3`, SHA-1 `017fd8140c477f9ae602cf95594f1c23bef1d6e3`.
...
- **LATEST_**[**CHANGES.MD**](http://CHANGES.MD)**:** adições/fixes específicos da 3.16.3.
