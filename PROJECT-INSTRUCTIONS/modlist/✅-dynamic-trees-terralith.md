...
- **Procedência:** modlist.txt física atual de 21/09/2026 — 587 mods incluindo o modloader — confirma `dtterralith-1.3.0.jar` / runtime 1.3.0, Dynamic Trees 1.7.2, Dynamic Trees Plus 1.3.2 e Terralith 2.6.2. CurseForge/source oficiais revalidados em 21/09/2026; 1.3.0 continua a release 1.21.1 mais recente.
...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 21/09/2026 — lote físico #229: dtterralith-1.3.0.jar / runtime 1.3.0 reconfirmados como latest Release NeoForge 1.21.1; drift entre baseline source e stack físico permanece regression gate de worldgen.
- **Decisão:** Manter
