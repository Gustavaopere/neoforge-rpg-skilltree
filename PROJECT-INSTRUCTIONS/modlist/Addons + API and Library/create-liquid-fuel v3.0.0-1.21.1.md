...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#192**: JAR `createliquidfuel-3.0.0-1.21.1.jar`, mod id `createliquidfuel`, runtime `3.0.0-1.21.1`, SHA-1 `9a88888ac915d32d8df240153421fdcb170ad88e`.
...
- **Dependências:** Pack físico: NeoForge 21.1.248 + Create 6.0.10. Fuel entries continuam data-driven; fluid providers externos não são hard dependencies por si.
