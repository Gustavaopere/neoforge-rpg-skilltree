...
- **Dependências:** Upstream 1.2.4 exige Minecraft 1.21.1, NeoForge 21.1.228+, Create, Create Stuff & Additions e Curios API. Pack físico usa NeoForge 21.1.250 + Create 6.0.10 + Create Stuff 'N Additions 2.1.4b (runtime literal 2.1.4.) + Curios API 9.5.1+1.21.1. A publicação foi testada upstream com CSA 2.1.4a.
