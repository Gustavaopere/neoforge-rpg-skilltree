...
- **Observações:** A linha Minecraft 1.21.1 permanece em 1.0.4. Builds 1.0.5/1.0.7 localizadas são de 1.21.11/26.1.2 e não constituem update aplicável ao pack atual.
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + CurseForge oficial JinxedLib: `jinxedlib-neoforge-1.21.1-1.0.4.jar` continua a release 1.21.1 mais recente; builds posteriores pertencem a outras linhas de Minecraft + changelog 1.0.4 já auditado.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — JinxedLib 1.0.4/JAR físico reconfirmado; 1.0.4 permanece a release NeoForge 1.21.1 mais recente localizada. Registry multi-consumer fix, data/tooling boundaries, lifecycle, riscos e testes preservados; releases 1.0.5/1.0.7 pertencem a Minecraft 1.21.11/26.1.2.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #350: JAR `jinxedlib-neoforge-1.21.1-1.0.4.jar`, mod id `jinxedlib`, runtime `1.0.4`, SHA-1 `4fcb38e30b7654cf94bdf7b4e1511ed860c31aae`.
