...
- **Procedência:** modlist.txt física reconferida em 13/09/2026 + CurseForge oficial file `lockonmovementfix-neoforge-1.0.2.jar`, ainda latest NeoForge 1.21.1 + source/README oficial Seramicx já auditado.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Lock-On Movement Fix 1.0.2/JAR físico reconfirmado; 1.0.2 permanece a release NeoForge 1.21.1 mais recente localizada. Epic Fight/Better Lock On/Bosses'Rise/FTB Teams/Iron's boundaries, locked-vs-unlocked dodge fix e testes preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #377: JAR `lockonmovementfix-neoforge-1.0.2.jar`, mod id `lockonmovementfix`, runtime `1.0.2`, SHA-1 `86125cb65be745822fa5e1fcaa7a87c3cefbd8f2`.
