...
- **Procedência:** snapshot física de 11/09/2026 — 595 entradas totais incluindo NeoForge modloader + runtime `createcolonies` 2.0.6 + CurseForge oficial revalidado em 12/09/2026; `CreateColonies-1.21.1-2.0.6.jar` de 13/07/2026 continua a release NeoForge 1.21.1 mais recente. O filename físico simplificado `createcolonies-2.0.6.jar` permanece authority local.
...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — registro histórico do lote físico #178 na snapshot então vigente; posição física atual #177: createcolonies-2.0.6.jar / runtime 2.0.6 reconfirmados como latest Release NeoForge 1.21.1; blueprint requirements/placement, rail/belt/bogey/deployer/station repairs, clipboard interoperability e schematic↔blueprint conversion permanecem atuais.
- **Decisão:** Sem decisão
