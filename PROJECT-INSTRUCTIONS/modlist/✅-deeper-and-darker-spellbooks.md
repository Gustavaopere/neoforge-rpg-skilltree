...
- **Dependências:** Obrigatórias: Deeper and Darker + Iron's Spells 'n Spellbooks. Pack físico atual confirma Deeper and Darker 1.4.1 e Iron's Spells 'n Spellbooks 1.21.1-3.16.3. A build instalada é Version B; não confundir com a variante A de 5% Eldritch Spell Power.
...
- **Procedência:** modlist.txt física atual de 20/09/2026 — 587 mods incluindo o modloader — confirma `darkermagic-1.3.3-1.21.1-ver.b.jar` / runtime 1.3.3-1.21.1. CurseForge oficial revalidado em 20/09/2026: File ID 7897469, Version B, Release NeoForge 1.21.1 de 09/04/2026, ainda a publicação mais recente dessa variante. Source público anterior permanece não equivalente byte-a-byte ao JAR 1.3.3.
...
- **Atualização/Status:** REATUALIZADO EM 20/09/2026 — lote físico #213: darkermagic-1.3.3-1.21.1-ver.b.jar / runtime 1.3.3-1.21.1 reconfirmados como latest Release NeoForge 1.21.1 na variante Version B; fix de crash dos summons em servidor e bônus de 10% Eldritch Spell Power permanecem atuais.
- **Decisão:** Sem decisão
