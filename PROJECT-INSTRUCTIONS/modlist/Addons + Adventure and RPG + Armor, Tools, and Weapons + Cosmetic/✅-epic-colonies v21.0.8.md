# Epic Fight: Epicfied (Epic Colonies)
...
- **Dependências:** Epic Fight 21.17.3.1 + MineColonies 1.1.1387-1.21.1-snapshot estão fisicamente presentes. O filename oficial registra compile target EFM-21.16.4; inspeção anterior do metadata upstream registrou ranges de loader amplos.
...
- **Atualização/Status:** REAUDITADO EM 21/09/2026 — registro histórico do lote físico #261 na snapshot então vigente; posição física atual #262: `EpicColonies-NeoForge-1.21.1-EFM-21.16.4-21.0.8.jar` / runtime `21.0.8` reconfirmados na snapshot física então vigente de 587 entradas top-level incluindo o modloader. CurseForge oficial mantém 21.0.8 como latest release NeoForge 1.21.1; compile target EFM-21.16.4 continua separado do runtime Epic Fight 21.17.3.1.
- **Decisão:** Manter
...
> **Runtime físico confirmado:** `EpicColonies-NeoForge-1.21.1-EFM-21.16.4-21.0.8.jar` · mod id `epic_colonies` · versão `21.0.8` · NeoForge 1.21.1. O pack usa **Epic Fight 21.17.3.1** e **MineColonies 1.1.1387-1.21.1-snapshot**.
## 1. Papel no modpack
...
## 12. Matriz de testes
1. Dedicated server com MineColonies 1.1.1387 + Epic Fight 21.17.3.1 + Epic Colonies 21.0.8.
