...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#208**: JAR `crystal_chronicles-0.1.3-alpha.jar`, mod id `crystal_chronicles`, runtime `0.1.3-alpha`, SHA-1 `afdc32ab27661cd52160280dc4273d70a2d4a3d2`.
...
- **Dependências:** Obrigatórias no projeto: AzureLib, Iron's Spells 'n Spellbooks, Biolith e Fusion. Pack físico atual confirma AzureLib 3.1.11, Iron's 1.21.1-3.16.3, Biolith 3.0.14 e Fusion 1.3.15+a. JEI/REI e Better Combat são recomendados, não hard dependencies.
