...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #454: JAR `powergrid-mc1.21.1-0.6.1.jar`, mod id `powergrid`, runtime `0.6.1`, SHA-1 `bb0139368f141b0d3a60707ef81c8e010cc72df9`.
...
## 8. Sable e dependências embedded
O JAR físico embute `sable-companion-common-1.21.1-1.6.0.jar` e quatro módulos EJML 0.44.0: `ejml-core-0.44.0.jar`, `ejml-ddense-0.44.0.jar`, `ejml-dsparse-0.44.0.jar` e `ejml-simple-0.44.0.jar`. Todos pertencem ao host Create: Power Grid nesta instalação e não recebem ordinal próprio.
