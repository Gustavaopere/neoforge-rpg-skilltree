...
- **Dependências:** Create obrigatório. Pack físico usa NeoForge 21.1.248 + Create 6.0.10. Release 1.2.2 é NeoForge 1.21.1, Client & Server; nenhuma dependência obrigatória adicional foi inferida da publicação da build.
