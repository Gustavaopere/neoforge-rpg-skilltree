...
- **Dependências:** Create 6.0.10 físico. JEI é opcional e recomendado pelo projeto para visualizar recipes. Build 0.5.2 é Client & Server, NeoForge 1.21.1, linha reescrita para Create 6.0.
