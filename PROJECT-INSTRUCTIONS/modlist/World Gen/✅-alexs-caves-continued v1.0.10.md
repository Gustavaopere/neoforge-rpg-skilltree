...
> **QC FÍSICO FINAL — 16/09/2026.** A modlist física mais recente fornece o fingerprint atual completo: `alexscaves-1.0.10-neoforge+1.21.1.jar`, mod id `alexscaves`, runtime `1.0.10`, SHA-1 `6960b299a39a039ac8a5eb9b07be4ad0e3e0a570`, mixin `alexscaves.mixins.json`, NeoForge 1.21.1. Este bloco corrige e supersede a frase do bloco de reauditoria imediatamente abaixo que dizia que a modlist não fornecia novo SHA-1; o SHA-1 histórico `64e4c99e...` continua pertencendo exclusivamente à build 1.0.9.

> **Reauditoria física — 16/09/2026.** A autoridade física mais recente agora é `alexscaves-1.0.10-neoforge+1.21.1.jar`, mod id `alexscaves`, runtime `1.0.10`, NeoForge 1.21.1. A versão 1.0.10, antes registrada abaixo apenas como upstream posterior, passou a estar efetivamente instalada. O delta já levantado para a 1.0.10 inclui correção de crash/log spam de worldgen nas Primordial Caves ligado ao freeze check de lagos, flicker/red flashes do céu no Abyssal Chasm, prioridade de subida do Submarine quando sprint está ativo, câmera do floodlight em 1.21.1 e outras correções visuais/compatibilidade. **Este bloco é a authority física atual e supersede exclusivamente as referências históricas abaixo que chamam 1.0.9 de “runtime físico/atual” ou 1.0.10 de “upstream não instalado”.** O restante do dossiê migrado do Notion é preservado integralmente como conteúdo técnico e histórico. A modlist física mais recente não forneceu novo SHA-1 nesta auditoria; o SHA-1 de 1.0.9 abaixo pertence ao snapshot histórico e não deve ser atribuído ao JAR 1.0.10.
