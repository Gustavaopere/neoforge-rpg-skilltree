...
- **Procedência:** modlist.txt física reconferida em 13/09/2026 + publicação oficial Legendary Spellbooks 0.3.2 NeoForge 1.21.1 + source oficial commit 62ced2f2b2693aa841251473cbbd726fdd928ed3; providers físicos Iron's 3.16.3 e Legendary Monsters 2.2.2 preservados como version gates de runtime.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Legendary Spellbooks 0.3.2/JAR físico reconfirmado; 0.3.2 permanece a build Beta NeoForge 1.21.1 mais recente localizada. 30 spells ativos, provider boundaries e version-skew risks preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #372: JAR `legendary_spellbooks-1.21.1+neo-0.3.2.jar`, mod id `legendary_spellbooks`, runtime `0.3.2`, SHA-1 `bda5b1fbe50ad834a6a76ad36789743c1057ebf5`.
