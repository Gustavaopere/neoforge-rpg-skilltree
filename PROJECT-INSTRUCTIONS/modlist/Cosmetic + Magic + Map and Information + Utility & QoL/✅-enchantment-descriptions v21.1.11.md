...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#250**: JAR `enchdesc-neoforge-1.21.1-21.1.11.jar`, mod id `enchdesc`, runtime `21.1.11`, SHA-1 `4d453df785ac21e0e7389cba949f4fa460c3e267`.
...
## 15. Evidências
- modlist física atual: JAR/mod id/version + Bookshelf/Prickle/Apothic presentes;
