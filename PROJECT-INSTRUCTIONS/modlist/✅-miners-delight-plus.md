...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Miner's Delight 1.4.5/JAR físico reconfirmado; 1.4.5 permanece a release NeoForge 1.21.1 mais recente localizada. Dossiê e decisão Manter preservados.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #398: JAR `minersdelight-1.21.1-1.4.5.jar`, mod id `minersdelight`, runtime `1.4.5`, SHA-1 `9361a43c3b2cfeda977d34a28e25a6e089465dcc`.
...
- Chunk unload/reload com conteúdo presente.
### Data/multiplayer
