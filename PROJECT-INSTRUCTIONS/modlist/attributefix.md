...
> Página-fonte: https://app.notion.com/p/3c369db9f0db81c2b9fae161e2f18d9d  
...
- **Dependências:** Minecraft/NeoForge + PrickleMC 21.1.11 para gerenciamento de configuração; presença física confirmada no pack.
...
- **Procedência:** Modlist física atual de 07/09/2026 + source oficial Darkhax-Minecraft/AttributeFix branch 1.21.1 + publicação/changelog oficial da release 21.1.3.
