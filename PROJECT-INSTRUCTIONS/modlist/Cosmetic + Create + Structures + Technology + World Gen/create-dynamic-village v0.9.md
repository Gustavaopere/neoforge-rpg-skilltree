...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#237**: JAR `dynamicvillage-0.9-1.21.1.jar`, mod id `dynamicvillage`, runtime `0.9`, SHA-1 `334ceffc91199d2755d81acd57d42dd94412c4bf`.
...
## 17. Evidências
- modlist física atual de 21/09/2026: JAR/mod id/versão 0.9, Create 6.0.10 e Integrated Villages 1.3.3+1.21.1-neoforge presente;
