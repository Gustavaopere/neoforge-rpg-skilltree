...
- **Observações:** JAR físico permanece 2101.1.34. A release 2101.1.35 corrige verificação de permissão do jogador que podia causar problemas quando outros mods executavam comandos `/ftbquests ...`; não atribuir esse fix à build instalada.
- **Procedência:** modlist.txt física atual de 11/09/2026 — 595 entradas totais incluindo o modloader — confirma `ftb-quests-neoforge-2101.1.34.jar`, mod id `ftbquests` e runtime 2101.1.34. CurseForge oficial revalidado em 12/09/2026 mantém 2101.1.35 como release 1.21.1 mais recente.
- **Histórico da decisão:** vazio.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — lote físico #291: FTB Quests 2101.1.34 reconfirmado; upstream 2101.1.35 Release para 1.21.1 disponível desde 09/09/2026.
...
Em 09/09/2026 foi publicada a **2101.1.35**. O changelog oficial corrige um bug na verificação de permissões do jogador que podia causar problemas quando outros mods executavam comandos `/ftbquests ...`. O JAR físico 2101.1.34 continua authority até mudança explícita da modlist; esse fix não é atribuído ao runtime atual.
