...
- **Procedência:** modlist(1).txt física atual de 22/09/2026 — 587 entradas top-level incluindo o modloader — confirma `fzzy_config-0.7.7+1.21+neoforge.jar`, mod id `fzzy_config`, runtime `0.7.7+1.21+neoforge` e SHA-1 `518eadc53c065a74a49207769209c116e77d1849`. A versão física não mudou nesta rodada.
