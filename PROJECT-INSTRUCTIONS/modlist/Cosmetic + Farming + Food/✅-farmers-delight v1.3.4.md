...
- **Atualização/Status:** REAUDITADO EM 21/09/2026 — lote físico #275: `FarmersDelight-1.21.1-1.3.4.jar` / runtime `1.3.4` reconfirmados na modlist física atual de 587 entradas top-level incluindo o modloader. A versão instalada não mudou nesta rodada; nenhum delta adicional de changelog foi promovido.
- **Decisão:** Manter
...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #276: JAR `FarmersDelight-1.21.1-1.3.4.jar`, mod id `farmersdelight`, runtime `1.3.4`, SHA-1 `27675ddfcb8cc37e6ea1ab6c15051c7949d94657`.
