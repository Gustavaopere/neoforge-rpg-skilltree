...
- **Atualização/Status:** REAUDITADO EM 21/09/2026 — registro histórico do lote físico #275 na snapshot então vigente; posição física atual #276: `FarmersDelight-1.21.1-1.3.4.jar` / runtime `1.3.4` reconfirmados na snapshot física então vigente de 587 entradas top-level incluindo o modloader. A versão instalada não mudou nesta rodada; nenhum delta adicional de changelog foi promovido.
- **Decisão:** Manter
