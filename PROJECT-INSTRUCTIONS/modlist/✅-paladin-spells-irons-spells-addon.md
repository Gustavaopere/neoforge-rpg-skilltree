...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial da release 1.1.1 e changelogs 0.33/0.342/1.1.1.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Paladin Spells 1.21.1-1.1.1/JAR físico reconfirmado; Iron's Spells 'n Spellbooks 3.16.3 permanece provider físico. Dossiê preservado.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #432: JAR `paladin_spells-1.21.1-1.1.1.jar`, mod id `paladin_spells`, runtime `1.21.1-1.1.1`, SHA-1 `e4c6f4fa70989f0b9f1819e46e29f68d414ccbaf`.
