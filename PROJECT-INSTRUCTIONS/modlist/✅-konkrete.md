...
- **Procedência:** modlist(1).txt física atual, com 587 entradas top-level incluindo o modloader, reconferida em 25/09/2026 + CurseForge oficial file ID 5453385 + repositório/changelog oficial Konkrete; runtime NeoForge 1.21.1.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Konkrete 1.9.9/JAR físico reconfirmado; inventário físico atual reconciliado para 587 entradas top-level incluindo o modloader. Source/ABI, mixins, side/lifecycle, riscos e testes preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #360: JAR `konkrete_neoforge_1.9.9_MC_1.21.jar`, mod id `konkrete`, runtime `1.9.9`, SHA-1 `97771eb287d5ac7fe667d1df9493d5e54c8ca1fa`.
