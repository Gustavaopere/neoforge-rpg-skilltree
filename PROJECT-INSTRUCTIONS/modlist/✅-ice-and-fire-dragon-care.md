...
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + source oficial OrionTheDragon/DragonCare módulo Addon exatamente em 1.3.1 + release/changelog oficial Dragon Care 1.3.1 + revalidação em 12/09/2026 do suporte explícito ao Ice And Fire CE 2.1.2.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — Dragon Care 1.3.1/JAR físicos reconfirmados; 1.3.1 permanece a release NeoForge 1.21.1 mais recente localizada. Suporte explícito ao Ice And Fire CE 2.1.2 e autodetection GeckoLib/Tabula-Uranus preservados.
