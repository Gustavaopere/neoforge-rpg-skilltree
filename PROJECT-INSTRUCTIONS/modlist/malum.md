...
- **Procedência:** modlist.txt física reconferida em 13/09/2026 + CurseForge oficial Malum confirmando `malum-1.21.1-1.8.2.jar` como latest release 1.21.1 + source oficial 1.8.2 já pinado no commit auditado.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Malum 1.8.2/JAR físico reconfirmado; 1.8.2 permanece a release NeoForge 1.21.1 mais recente localizada. Spirit Arcana, 7 recipe types, attachments persistentes/sincronizados, Iron's integration, Soul Ward/Geasa/Avarice, worldgen, mixins, lifecycle e riscos preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #389: JAR `malum-1.21.1-1.8.2.jar`, mod id `malum`, runtime `1.8.2`, SHA-1 `7bea3f874f186a17ad3e271df145c179e81c2a1d`.
...
- Source oficial: [https://github.com/SammySemicolon/Malum-Mod](https://github.com/SammySemicolon/Malum-Mod)
- Commit pinado 1.8.2: [https://github.com/SammySemicolon/Malum-Mod/commit/03b743a37f3eeb0cc7f4364f0730e1f135f78408](https://github.com/SammySemicolon/Malum-Mod/commit/03b743a37f3eeb0cc7f4364f0730e1f135f78408)
