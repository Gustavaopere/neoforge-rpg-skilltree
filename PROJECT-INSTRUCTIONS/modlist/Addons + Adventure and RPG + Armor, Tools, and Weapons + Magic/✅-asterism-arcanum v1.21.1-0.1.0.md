...
> **Autoridade física atual — 22/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#56**: `asterismarcanum-1.21.1-0.1.0.jar`, mod id `asterismarcanum`, runtime `1.21.1-0.1.0`, SHA-1 `4a25ba80116168ddcc812f71467c0598127e774a`.

> **Reauditoria física — 19/09/2026.** JAR top-level reconfirmado na modlist física atual: `asterismarcanum-1.21.1-0.1.0.jar`, versão `1.21.1-0.1.0`. Paridade Notion → GitHub revalidada; URL da própria página Notion removida.
