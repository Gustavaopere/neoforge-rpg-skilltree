...
- **Procedência:** modlist(1).txt física atual de 22/09/2026 — 587 entradas top-level incluindo o modloader — confirma `gtbcs_geomancy_plus-1.1.0-1.21.1.jar`, mod id `gtbcs_geomancy_plus`, runtime `1.1.0-1.21.1` e SHA-1 `67e9652799f35f1fbd09968da6f400d0229f5599`. CurseForge oficial revalidado em 22/09/2026 mantém 1.1.0 como release NeoForge 1.21.1 atual.
