...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #281: JAR `firesenderexpansion-2.4.1.jar`, mod id `firesenderexpansion`, runtime `2.4.1`, SHA-1 `da87a4a0c926dd75236766584cddbae69c6aeff7`.
