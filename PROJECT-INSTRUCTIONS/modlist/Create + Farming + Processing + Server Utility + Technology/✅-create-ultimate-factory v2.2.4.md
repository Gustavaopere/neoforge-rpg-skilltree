...
> **Autoridade física atual — 23/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#165**: JAR `create_ultimate_factory-2.2.4-neoforge-1.21.1.jar`, mod id `create_ultimate_factory`, runtime `2.2.4`, SHA-1 `ed0ff71df9bfe3b66b97c51a2834031084300a65`.
...
- **Dependências:** Create obrigatório; pack físico usa NeoForge 21.1.250 + Create 6.0.10. JEI é recomendado para visualização. A integração especial com Create Aeronautics na 2.2.4 continua condicional à presença do addon e altera a rota de End Stone.
