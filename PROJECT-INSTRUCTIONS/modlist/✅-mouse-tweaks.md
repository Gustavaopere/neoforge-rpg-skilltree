...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Mouse Tweaks 2.26.1 continua sendo a release NeoForge aplicável a Minecraft 1.21.1 mais recente localizada; dossiê preservado.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #409: JAR `MouseTweaks-neoforge-mc1.21-2.26.1.jar`, mod id `mousetweaks`, runtime `2.26.1`, SHA-1 `6dae57f4f50f7808d2ed9a18f6cd1c0d4640c6bc`.
