...
- **Dependências:** JEI como viewer funcional; pack usa JEI 19.56.0.440. Build 4.0.5 é Release NeoForge 1.21.1 e classificada client-side.
...
- **Procedência:** modlist(1).txt física anexada e reconferida em 25/09/2026 + Modrinth/CurseForge oficiais Just Enough Professions 4.0.5 NeoForge 1.21.1 + changelog exato 4.0.5 + JEI físico 19.56.0.440.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — JEP 4.0.5/JAR físico reconfirmado; JEI físico reconciliado para 19.56.0.440. O restante do dossiê permanece preservado.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #355: JAR `JustEnoughProfessions-neoforge-1.21.1-4.0.5.jar`, mod id `justenoughprofessions`, runtime `4.0.5`, SHA-1 `439ea1baa5e3065e36e0e57422f22403918bb59f`.
...
## 2. Integração JEI
O pack usa JEI 19.56.0.440. JEP depende da API/registration do viewer para expor sua informação. Atualizar JEI é version gate para o plugin mesmo que villagers continuem funcionando normalmente.
## 3. Profissões modded
...
- [ ] Cliente inicia com JEP 4.0.5 + JEI 19.56.0.440.
