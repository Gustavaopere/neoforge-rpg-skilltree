...
- **Dependências:** Source matching 2.3a-BETA: Minecraft 1.21.1, NeoForge \>=21.1.200, Create 6.0.10-280, Flywheel 1.0.6, Ponder 1.0.82 e Registrate MC1.21-1.3.0+67. Pack físico usa NeoForge 21.1.250 + Create 6.0.10 + Sable 2.0.5; JEI/Curios/Sable seguem superfícies de integração, não hard dependencies inferidas além do metadata/source.
...
- **Procedência:** modlist.txt física atual de 20/09/2026 — 587 mods incluindo o modloader — confirma `DnDesires-1.21.1-2.3a-BETA.jar` / runtime 2.3a-BETA. Source oficial branch 1.21.1 matching e CurseForge/Modrinth oficiais revalidados em 20/09/2026; 2.3a-BETA de 04/05/2026 continua a publicação 1.21.1 mais recente.
- **Observações:** Filename/runtime permanece `2.3a-BETA`; não normalizar o identificador. A distribuição pública atual classifica o arquivo como Release apesar do sufixo BETA. Changelog mantém Spud Sentry, Sable compat, boiler stats no Fluid Gauge, fixes de fluid/Smart Hopper/Bore e tentativa de correção do Gold Mixer crash.
- **Atualização/Status:** REATUALIZADO EM 20/09/2026 — lote físico #222: DnDesires-1.21.1-2.3a-BETA.jar / runtime 2.3a-BETA reconfirmados como publicação 1.21.1 mais recente. O identificador contém BETA, enquanto CurseForge/Modrinth classificam o arquivo como Release; ambos os fatos foram preservados.
- **Decisão:** Sem decisão
