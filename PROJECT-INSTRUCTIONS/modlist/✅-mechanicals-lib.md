...
- **Procedência:** modlist(1).txt física anexada e reconferida em 25/09/2026 + source oficial oierbravo/mechanicals-lib branch 1.21.1 exatamente 1.1.6 + metadata, registries, tree e changelog oficiais.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Mechanicals Lib 1.1.6/JAR físico reconfirmado na modlist atual; runtime do pack NeoForge 21.1.250. 1.1.6 permanece a release NeoForge 1.21.1 mais recente localizada. Dossiê técnico e dependências embarcadas preservados.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #392: JAR `mechanicals-1.21.1-1.1.6.jar`, mod id `mechanicals`, runtime `1.1.6`, SHA-1 `65818a9a904983c39acfd7b2da3fe784bd35e83b`.

<callout icon="⚙️" color="blue_bg">
	**ESCOPO CANÔNICO.** Runtime físico: `mechanicals-1.21.1-1.1.6.jar`, mod id `mechanicals`, versão `1.1.6`. O source oficial `oierbravo/mechanicals-lib`, branch `1.21.1`, declara exatamente 1.1.6, Minecraft 1.21.1 e NeoForge mínimo 21.1.219. O JAR físico também contém Registrate 1.3.0+67, Flywheel 1.0.6 e Ponder 1.0.82 como JarJar internos; eles pertencem ao host e não viram entradas top-level separadas neste catálogo.
</callout>
## 1. Papel no pack
...
## 12. Matriz de testes
- [ ] Dedicated server inicia com NeoForge 21.1.250 e consumers atuais.
