...
- **Dependências:** Minecraft 1.21.1 e NeoForge na build; Java 21. Consumer físico confirmado: FancyMenu. Não há dependência inversa de FancyMenu declarada por Melody; FancyMenu consome a API. Runtime do pack: NeoForge 21.1.250.
...
- **Procedência:** modlist(1).txt física anexada e reconferida em 25/09/2026 + CurseForge/Modrinth oficiais confirmando `melody_neoforge_1.0.10_MC_1.21.jar` para 1.21/1.21.1/1.21.4 + source oficial 1.0.10 já auditado.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Melody 1.0.10/JAR físico reconfirmado; runtime do pack NeoForge 21.1.250. 1.0.10 permanece a release NeoForge aplicável ao Minecraft 1.21.1. Releases 1.0.14/1.0.15 pertencem a Minecraft 1.21.10/1.21.11. AudioClip/OpenAL, SoundEngine observers e client lifecycle preservados.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #393: JAR `melody_neoforge_1.0.10_MC_1.21.jar`, mod id `melody`, runtime `1.0.10`, SHA-1 `e83052a92c4ca0016bcfe7f0207273983dc84698`.
...
- NeoForge de desenvolvimento 21.1.47; runtime físico do pack é 21.1.250.
...
## 12. Matriz de testes
- [ ] Cliente NeoForge 21.1.250 inicia com Melody 1.0.10 + FancyMenu atual.
