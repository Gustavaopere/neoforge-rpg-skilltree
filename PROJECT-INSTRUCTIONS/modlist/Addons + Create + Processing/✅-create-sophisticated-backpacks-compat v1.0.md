...
- **Dependências:** Create 6.0.10 + Sophisticated Backpacks 3.26.3 + Sophisticated Core 1.5.1 estão fisicamente presentes. O compat continua recipe-focused; a metadata runtime do próprio JAR declara versão vazia.
...
Para catalogação: filename + mod id + publicação oficial identificam o artefato como 1.0; a versão runtime permanece vazia porque é assim que o JAR se apresenta.
