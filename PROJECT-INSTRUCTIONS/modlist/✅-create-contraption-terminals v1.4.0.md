...
- **Dependências:** Pack físico: NeoForge 21.1.248 + Create 6.0.10 + Tom's Simple Storage 2.4.2. A 1.4.0 corrige explicitamente crash/compatibilidade com versões mais novas do Tom's.
