...
- **Compatibilidade/Riscos:** Riscos em migração/config reset 3.2, database LOD stale/corrompido, pressão de CPU/RAM/I/O, competição com pregen/worldgen pesado, render/shader/fog, protocol drift e multiplayer experimental/incompleto da linha 3.2. Version drift atual: a modlist permanece em 3.2.0-b enquanto a release pública 1.21.1 avançou para 3.3.1 em 18/09/2026; não tratar mudanças 3.3.x como presentes até atualização física.
- **Fonte:** https://gitlab.com/distant-horizons-team/distant-horizons
- **Procedência:** modlist.txt física atual de 20/09/2026 — 587 mods incluindo o modloader — confirma `DistantHorizons-3.2.0-b-1.21.1-fabric-neoforge.jar` / runtime 3.2.0-b e dependências embarcadas. Releases/changelogs oficiais e source GitLab revalidados em 20/09/2026; CurseForge oficial lista 3.3.1 para Minecraft 1.21.1 em 18/09/2026, de modo que existe atualização disponível acima do runtime físico instalado.
- **Observações:** Distant Horizons 3.2.0-b é a versão física instalada — infraestrutura de LOD/renderização distante com cache próprio. Em 18/09/2026 foi publicada a release 3.3.1 para Minecraft 1.21.1, ainda não presente na modlist física. O risco principal permanece concentrado em compatibilidade gráfica, shaders, render pipeline e invalidadores de cache/worldgen; revalidar especialmente antes de qualquer upgrade 3.2.0-b → 3.3.x.
- **Atualização/Status:** REATUALIZADO EM 20/09/2026 — lote físico #221: DistantHorizons-3.2.0-b-1.21.1-fabric-neoforge.jar / runtime 3.2.0-b permanecem como autoridade instalada. A publicação oficial para Minecraft 1.21.1 avançou para 3.3.1 em 18/09/2026; portanto 3.2.0-b não é mais a latest pública. LOD/database, config migration, server/network alpha e render boundaries do runtime instalado permanecem documentados.
- **Decisão:** Sem decisão
