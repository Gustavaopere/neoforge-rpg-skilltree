...
- **Dependências:** Productive Metalworks 1.21.1-1.15.1; KubeJS 2101.7.2-build.377; NeoForge 1.21.1. Ambos os providers estão fisicamente presentes.
...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial KubeJS Metalworks 1.0.0 + documentação oficial de helpers.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Productive Metalworks KubeJS Addon 1.0.0/JAR físico reconfirmado; Productive Metalworks 1.21.1-1.15.1 e KubeJS 2101.7.2-build.377 presentes; decisão Manter preservada.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-06

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #457: JAR `productive-metalworks-kubejs-addon-1.0.0.jar`, mod id `pmw_kubejs_addon`, runtime `1.0.0`, SHA-1 `51d26c16460baa42fc72400ecc3fbc23d3ad2f86`.
