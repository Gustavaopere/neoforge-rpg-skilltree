...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#196**: JAR `createmissiles-1.0.3+neoforge-1.21.1.jar`, mod id `createmissiles`, runtime `1.0.3`, SHA-1 `4bce5c006184407bfa1932c3071491ef3a8d8fdf`.
...
- **Dependências:** Create obrigatório; pack físico usa NeoForge 21.1.248 + Create 6.0.10, alinhado à build 1.0.3. JEI/Ponder permanecem superfícies de apresentação; Create Big Cannons 5.11.7 é overlap bélico concreto, não dependência.
