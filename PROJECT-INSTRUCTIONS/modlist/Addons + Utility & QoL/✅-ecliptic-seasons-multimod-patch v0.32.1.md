...
- **Dependências:** Ecliptic Seasons. Integrações 1.21.1 oficialmente suportadas e fisicamente ativas no pack: Presence Footsteps `1.12.0-beta.1`, JourneyMap `6.0.8`, Cold Sweat `2.4.3.1`, Dynamic Trees `1.7.2` e MineColonies `1.1.1387-1.21.1-snapshot`.
...
## 17. Evidências
- modlist física atual de 21/09/2026: JAR, mod id, versão 0.32.1 e providers ativos;
