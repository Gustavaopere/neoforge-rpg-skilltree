...
- **Atualização/Status:** REVALIDADO EM 20/09/2026 — registro histórico do lote físico #152 na snapshot então vigente; posição física atual #153: create_pillagers_arise NeoForge 1.21.1-132.36.jar / 132.36 confirmados como latest NeoForge 1.21.1; 10 structures, pillager encounters, worldgen/config boundaries e ressalva do changelog rotulado 132.34 permanecem atuais.
- **Decisão:** Sem decisão
