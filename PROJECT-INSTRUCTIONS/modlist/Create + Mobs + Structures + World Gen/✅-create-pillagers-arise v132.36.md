...
> **Autoridade física atual — 23/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#153**: JAR `create_pillagers_arise NeoForge 1.21.1-132.36.jar`, mod id `create_pillagers_arise`, runtime `132.36`, SHA-1 `ffc083a957c3e527d9aabf3fb851b780ef443b5a`.
...
- **Dependências:** Create obrigatório. Release 132.36 é NeoForge 1.21.1, Client & Server; pack físico usa NeoForge 21.1.250 + Create 6.0.10.
...
- **Procedência:** modlist.txt física atual de 16/09/2026 + runtime `create_pillagers_arise` 132.36 + CurseForge oficial revalidado em 20/09/2026; 132.36 continua a release mais recente para NeoForge 1.21.1.
...
- **Atualização/Status:** REVALIDADO EM 20/09/2026 — lote físico #152: create_pillagers_arise NeoForge 1.21.1-132.36.jar / 132.36 confirmados como latest NeoForge 1.21.1; 10 structures, pillager encounters, worldgen/config boundaries e ressalva do changelog rotulado 132.34 permanecem atuais.
- **Decisão:** Sem decisão
