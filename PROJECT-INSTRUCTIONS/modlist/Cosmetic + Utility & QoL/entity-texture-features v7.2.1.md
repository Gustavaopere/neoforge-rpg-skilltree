...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#256**: JAR `entity_texture_features-7.2.1-1.21-neoforge.jar`, mod id `entity_texture_features`, runtime `7.2.1`, SHA-1 `908d09263709193b918fdc9ca0d79c9d90c4a531`.
