...
- **Atualização/Status:** REAUDITADO EM 21/09/2026 — registro histórico do lote físico #255 na snapshot então vigente; posição física atual #256: `entity_texture_features-7.2.1-1.21-neoforge.jar` / runtime `7.2.1` reconfirmados na snapshot física então vigente de 587 entradas top-level incluindo o modloader. CurseForge oficial continua com 7.2.1 como release aplicável a NeoForge 1.21.1.
- **Decisão:** Sem decisão
