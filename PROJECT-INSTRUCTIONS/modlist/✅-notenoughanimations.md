...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #420: JAR `notenoughanimations-neoforge-1.12.4-mc1.21.1.jar`, mod id `notenoughanimations`, runtime `1.12.4`, SHA-1 `b509863deaa27890f8db600f612966a07490a6cd`.
