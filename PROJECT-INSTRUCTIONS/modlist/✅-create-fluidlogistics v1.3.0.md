...
- **Procedência:** modlist(1).txt física atual de 18/09/2026 + CurseForge oficial da release Create: FluidLogistic 1.3.0 para NeoForge 1.21.1, publicada em 16/09/2026, com changelog oficial.
...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 18/09/2026 — runtime físico atualizado para `fluidlogistics-1.3.0-mc1.21.1.jar` / `1.3.0`. Release oficial NeoForge 1.21.1 de 16/09/2026 incorporada: otimização do rendering de package fluid, processamento paralelo no Mechanical Fluid Gun, correção do toggle de blaze cooler conversion e correção de empty bucket extra no bulk cooling.
- **Decisão:** Sem decisão
