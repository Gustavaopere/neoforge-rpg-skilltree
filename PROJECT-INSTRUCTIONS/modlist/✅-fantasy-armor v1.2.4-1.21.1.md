...
A release física **1.2.4-1.21.1** possui changelog oficial específico: correção do problema de **Turkish i**. Isso é uma correção de texto/localização da build instalada, não mudança de armor stats.
