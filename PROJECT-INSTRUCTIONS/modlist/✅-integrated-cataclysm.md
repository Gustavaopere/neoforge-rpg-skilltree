...
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + CurseForge oficial Integrated Cataclysm 1.0.6 NeoForge 1.21.1 + descrição/dependencies/configuration já auditadas. Revalidação em 12/09/2026 não encontrou build 1.21.1 posterior.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — Integrated Cataclysm 1.0.6+1.21.1-neoforge/JAR físico reconfirmado; 1.0.6 permanece a release NeoForge 1.21.1 mais recente localizada. Overhaul estrutural, Create puzzles/traps, recipes/datapacks, structure-set control, provider ownership, worldgen/lifecycle, riscos e testes preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #333: JAR `integrated_cataclysm-1.0.6+1.21.1-neoforge.jar`, mod id `integrated_cataclysm`, runtime `1.0.6+1.21.1-neoforge`, SHA-1 `d9490abb8c6c66c61eabd836ffb016d385fd2b75`.
