...
- **Dependências:** NeoForge 1.21.1; build Client & Server. Pack físico atual usa NeoForge 21.1.250. `darkermagic-1.3.3-1.21.1-ver.b.jar` / Deeper and Darker: Spellbooks é top-level separado e depende deste provider, não o contrário.
...
- **Procedência:** modlist.txt física atual de 20/09/2026 — 587 mods incluindo o modloader + runtime `deeperdarker` 1.4.1 + CurseForge/Modrinth oficiais revalidados em 20/09/2026; 1.4.1 de 05/06/2026 continua a release NeoForge 1.21.1 mais recente.
...
- **Atualização/Status:** REATUALIZADO EM 20/09/2026 — lote físico #214: deeperdarker-neoforge-1.21.1-1.4.1.jar / runtime 1.4.1 reconfirmados como latest Release NeoForge 1.21.1; Otherside/worldgen/progression, Sculk Transmitter e fix server-side de Crystallized Amber permanecem atuais.
- **Decisão:** Sem decisão
