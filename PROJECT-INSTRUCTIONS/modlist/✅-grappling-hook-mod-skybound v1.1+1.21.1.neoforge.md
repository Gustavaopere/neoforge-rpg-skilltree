...
- **Procedência:** modlist(1).txt física atual de 22/09/2026 — 587 entradas top-level incluindo o modloader — confirma `grapplemod-1.1+1.21.1.neoforge.jar`, mod id `grapplemod`, runtime `1.1+1.21.1.neoforge` e SHA-1 `2b6060de273f721857d715db9a811ddaa5422683`. CurseForge oficial revalidado em 22/09/2026 mantém v1.1 como release NeoForge 1.21.1 atual; source branch continua usado apenas estruturalmente por drift de metadata.
