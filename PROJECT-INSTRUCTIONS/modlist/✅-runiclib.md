...
- **Dependências:** NeoForge 1.21.1. Consumer confirmado: Dungeon's Delight 1.5.1; linha recente exige RunicLib \>=5.0.0. RunicLib 5.0.7 satisfaz o mínimo.
...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial RunicLib 5.0.7 + consumer Dungeon's Delight 1.5.1/relation oficial já auditados.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — RunicLib 5.0.7/JAR físico reconfirmado. Consumer Dungeon's Delight físico atualizado para a distribuição 1.5.1; RunicLib \>=5.0.0 continua requerido e 5.0.7 satisfaz o mínimo. Decisão Dependência preservada.
- **Histórico da decisão:** 2026-09-10 — reclassificado de Sem decisão para Dependência após confirmação causal: Dungeon's Delight está instalado e lista RunicLib como Required Dependency; a linha 1.4.4+ exige RunicLib 5.0.0+. 2026-09-25 — consumer físico atualizado para Dungeon's Delight 1.5.1; RunicLib 5.0.7 permanece compatível.
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #417: JAR `neoforge-runiclib-1.21.1-5.0.7.jar`, mod id `runiclib`, runtime `5.0.7`, SHA-1 `f0422c70689d5b31b65ef5a84c1d5eb2d7536d4c`.

<callout icon="🔎" color="yellow_bg">
	**ESCOPO CANÔNICO.** Runtime físico: `neoforge-runiclib-1.21.1-5.0.7.jar`, mod id `runiclib`, versão `5.0.7`, NeoForge 1.21.1. RunicLib é uma library multiloader do ecossistema AZURUNE/Yirmiri. Neste pack ela deixa de ser apenas “biblioteca presente”: **Dungeon's Delight 1.5.1 é consumer confirmado** e a linha recente desse addon exige RunicLib 5.0.0+. Portanto a decisão correta é **Dependência**.
</callout>
...
O pack contém `neoforge-dungeonsdelight-1.21.1-1.5.1.jar`. O projeto Dungeon's Delight lista **RunicLib como Required Dependency**, e a linha 1.4.4+ estabelece RunicLib **5.0.0+**.
...
## 13. Matriz de testes
- [ ] Dedicated server inicia com RunicLib 5.0.7 + Dungeon's Delight 1.5.1.
