...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #424: JAR `obscure_tooltips-neoforge-1.21.1-4.2.4.jar`, mod id `obscure_tooltips`, runtime `4.2.4`, SHA-1 `3ff84162783758da0af3bfb67def80d79b442acd`.
