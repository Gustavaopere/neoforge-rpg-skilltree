...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#198**: JAR `createornithopterglider-1.2.0-1.21.1.jar`, mod id `createornithopterglider`, runtime `1.2.0-1.21.1`, SHA-1 `c966977d7df7ceaca24b644ee610e907d6bdd5c1`.
...
- **Dependências:** Create obrigatório; pack físico usa NeoForge 21.1.248 + Create 6.0.10 + Curios 9.5.1. Curios permanece opcional na 1.2.0 e Caelus não é dependência desta build.
