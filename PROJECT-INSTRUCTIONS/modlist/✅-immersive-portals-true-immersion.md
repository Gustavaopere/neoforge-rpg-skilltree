...
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + CurseForge oficial True Immersion 2.0.4 file 8600736, Release NeoForge 1.21.1 de 08/08/2026 + descrição oficial de interações through-portals. A listagem atual de arquivos confirma que 2.0.4 continua a última build 1.21.1; source/changelog exatos permanecem não localizados.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — Immersive Portals: True Immersion 2.0.4/JAR físico reconfirmado; 2.0.4 permanece a release NeoForge 1.21.1 mais recente localizada. Escopo through-portal interaction, rewrite-core 6.0.7 boundary, authority client/server, lifecycle/multiplayer, riscos e testes preservados; changelog 2.0.4 continua indisponível.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #330: JAR `immersive_portals_true_immersion-2.0.4.jar`, mod id `immersive_portals_full_immersion`, runtime `2.0.4`, SHA-1 `c74e38e5e1d1878b1ed67bb3be8ab1d93362fb13`.
