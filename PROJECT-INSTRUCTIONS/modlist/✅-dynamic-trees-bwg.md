...
- **Procedência:** modlist.txt física atual de 21/09/2026 — 587 mods incluindo o modloader — confirma `dtbwg-1.1.0-BETA02.jar` / runtime 1.1.0-BETA02, Dynamic Trees 1.7.2 e BWG 2.6.0. CurseForge oficial File ID 7208105 revalidado em 21/09/2026; continua sendo a Beta 1.21.1 mais recente.
- **Observações:** BETA02 permanece current para NeoForge 1.21.1. Changelog oficial confirma Spirit Tree no Pale Bog, Soul Fruit e atualização dos fruit models de Yucca/Baobab; a lista completa de species/families segue fail-closed sem source/tag exato.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 21/09/2026 — lote físico #227: dtbwg-1.1.0-BETA02.jar / runtime 1.1.0-BETA02 reconfirmados como latest Beta NeoForge 1.21.1; Spirit Tree/Pale Bog, Soul Fruit e modelos Yucca/Baobab permanecem os deltas confirmados da build.
- **Decisão:** Sem decisão
...
- modlist física atual de 21/09/2026: JAR/mod id/version e stack runtime;
