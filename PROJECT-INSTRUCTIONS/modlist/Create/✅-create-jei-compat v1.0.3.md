...
> **Autoridade física atual — 23/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#190**: JAR `createjeicompat-1.0.3.jar`, mod id `createjeicompat`, runtime `1.0.3`, SHA-1 `3435d67651913cf2105a4994d9a6af2873df37ac`.
...
- **Dependências:** Create + JEI obrigatórios. Pack físico: NeoForge 21.1.248 + Create 6.0.10 + JEI 19.53.0.426. EMI/JEmi permanecem integrações opcionais upstream e não são providers top-level ativos no pack.
