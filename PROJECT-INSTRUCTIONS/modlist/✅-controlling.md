...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — reconciliação final física #107: `Controlling-neoforge-1.21.1-19.0.5.jar` / `19.0.5` conferidos contra a modlist atual; Searchables dependency, keybind search/conflict authority, client lifecycle, screen interoperability e regressão de double modifier preservados.
