...
> **Autoridade física atual — 23/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#189**: JAR `creategoggles-1.21.1-6.1.1-[NEOFORGE].jar`, mod id `creategoggles`, runtime `6.1.1`, SHA-1 `e0285c31a2d2501439264c33c965409c422cd5b1`.
...
- **Dependências:** Pack físico: NeoForge 21.1.248 + Create 6.0.10 + Architectury 13.0.11. Source matching 6.1.1 foi desenvolvido contra Create/Architectury anteriores; JEI continua opcional para descoberta.
