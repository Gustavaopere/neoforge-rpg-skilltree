...
> **Autoridade física atual — 22/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#76**: JAR `biolith-neoforge-3.0.14.jar`, mod id `biolith`, runtime `3.0.14`, SHA-1 `8b041bce1cd0c5f5223c285784a3e8498273d6ea`.

> **Reauditoria física — 19/09/2026.** JAR top-level reconfirmado na modlist física atual: `biolith-neoforge-3.0.14.jar`, versão `3.0.14`. Paridade Notion → GitHub revalidada; URL da própria página Notion removida.
> **Registro histórico da reauditoria de 19/09/2026:** o arquivo registrava ordem #75 na contagem então usada de 586 mods top-level. A autoridade física atual está no callout acima e fixa Biolith em **#76 incluindo o modloader**. O ordinal #76 embutido em `Atualização/Status` permanece como conteúdo de paridade.
...
- **Procedência:** modlist.txt física atual de 11/09/2026 + GitHub/Modrinth/CurseForge oficiais Biolith v3.0.14, release commit `996b7a4`, e fontes já auditadas no dossiê. Reconciliação final: JAR/runtime permanecem exatamente `biolith-neoforge-3.0.14.jar` / `3.0.14`; sem divergência física.
- **Fonte:** https://www.curseforge.com/minecraft/mc-mods/biolith
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 11/09/2026 — reconciliação final física #76: `biolith-neoforge-3.0.14.jar` / `3.0.14` conferidos contra a modlist atual; release commit `996b7a4`, biome placement, datapack/surface-rule lifecycle e coexistência com BCLib/TerraBlender preservados.
