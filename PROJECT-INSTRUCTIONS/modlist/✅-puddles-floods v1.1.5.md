...
- **Dependências:** Forgified Fabric API 0.116.15+2.3.5+1.21.1 é Required Dependency da build NeoForge 1.21.1 e está fisicamente presente. Sinytra Connector NÃO é requisito desta build nativa NeoForge.
...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge/Modrinth oficiais Puddles & Floods 1.1.5 + presença física de Forgified Fabric API 0.116.15+2.3.5+1.21.1.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Puddles & Floods 1.1.5/JAR físico reconfirmado; Forgified Fabric API físico reconciliado para 0.116.15+2.3.5+1.21.1.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #461: JAR `puddleflood-1.1.5+1.21.1-neoforge.jar`, mod id `puddleflood`, runtime `1.1.5`, SHA-1 `b9b38904646d196454a788dc37c5ce3b4fb43014`.
