...
> **Autoridade física atual — 23/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#149**: JAR `create_mobile_packages-1.21.1-0.7.7.jar`, mod id `create_mobile_packages`, runtime `0.7.7`, SHA-1 `b0eb4d3ae9641c06754b20b9621f23bd607373a8`.
...
- **Dependências:** Upstream 0.7.7 exige NeoForge 21.1.206+ e Create 6.0.9+. O pack físico usa NeoForge 21.1.250 + Create 6.0.10. `create_factory_abstractions-1.21.1-1.6.0.jar` está embarcado via jar-in-jar no host e não é top-level.
...
- **Procedência:** modlist.txt física atual de 16/09/2026 + runtime `create_mobile_packages` 0.7.7 + CurseForge oficial revalidado em 20/09/2026; 0.7.7 continua a release mais recente para NeoForge 1.21.1 e mantém Factory Abstractions 1.6.0 embarcado.
...
- **Atualização/Status:** REVALIDADO EM 20/09/2026 — lote físico #148: create_mobile_packages-1.21.1-0.7.7.jar / 0.7.7 confirmados como latest NeoForge 1.21.1; Logistics Network, Bee Port/Robo Bee, Portable Stock Ticker, Mobile Packager, Factory Abstractions 1.6.0 embedded e regressões 0.7.7 permanecem atuais.
- **Decisão:** Sem decisão
