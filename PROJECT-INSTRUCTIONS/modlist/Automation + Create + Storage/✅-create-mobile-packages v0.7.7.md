...
- **Atualização/Status:** REVALIDADO EM 20/09/2026 — registro histórico do lote físico #148 na snapshot então vigente; posição física atual #149: create_mobile_packages-1.21.1-0.7.7.jar / 0.7.7 confirmados como latest NeoForge 1.21.1; Logistics Network, Bee Port/Robo Bee, Portable Stock Ticker, Mobile Packager, Factory Abstractions 1.6.0 embedded e regressões 0.7.7 permanecem atuais.
- **Decisão:** Sem decisão
