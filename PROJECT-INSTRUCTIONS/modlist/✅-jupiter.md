...
- **Observações:** 2.3.7 continua atual para Minecraft 1.21.1. Fixes publicados permanecem LAN permission pass, traduções Cloth e extra-config loading/warning spam; nenhuma mudança adicional foi atribuída sem changelog específico.
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + CurseForge oficial Jupiter file 7738312, release 2.3.7 NeoForge 1.21.1 + source/README V2 e consumers físicos já auditados. Revalidação não encontrou build 1.21.1 posterior.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — Jupiter 2.3.7/JAR físico reconfirmado; 2.3.7 permanece a release NeoForge 1.21.1 mais recente localizada. V2 config/sync, permissions, custom codecs, Extra Config System, consumers Ice and Fire CE/Dread Land, lifecycle, riscos e testes preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #353: JAR `jupiter-2.3.7-1.21.1-neoforge.jar`, mod id `jupiter`, runtime `2.3.7`, SHA-1 `569fb484ea5c8e8d690945ad4cd132131a719751`.
