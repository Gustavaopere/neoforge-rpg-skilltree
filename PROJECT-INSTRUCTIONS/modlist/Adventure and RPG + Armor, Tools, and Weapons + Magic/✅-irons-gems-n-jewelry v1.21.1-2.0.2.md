...
- **Observações:** A linha 1.21.1 permanece em 2.0.2. A build numericamente posterior `2.0.2.1` é exclusiva da linha Minecraft 26.1.2 e não deve ser tratada como update para este pack.
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + CurseForge oficial Iron's Gems 'n Jewelry: `irons_jewelry-1.21.1-2.0.2.jar` continua a release 1.21.1 mais recente; builds `2.0.2.1` posteriores pertencem a Minecraft 26.1.2 + source/wiki oficiais já auditados.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — Iron's Gems 'n Jewelry 1.21.1-2.0.2/JAR físico reconfirmado; 2.0.2 permanece a release NeoForge 1.21.1 mais recente localizada. Jewelcrafting, patterns/material tags, Jeweler economy, Iron's Lib 2.x API, damage-event safeguard, lifecycle, riscos e testes preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #340: JAR `irons_jewelry-1.21.1-2.0.2.jar`, mod id `irons_jewelry`, runtime `1.21.1-2.0.2`, SHA-1 `2f8d934d04111037dcf3fe7b04c96aec892da744`.
