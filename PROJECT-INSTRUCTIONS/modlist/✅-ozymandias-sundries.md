...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial da release 0.0.5 + descrição oficial de items/spells. Divergência de metadata 0.0.1 preservada fail-closed.
- **Atualização/Status:** REVALIDADO EM 25/09/2026 — Ozymandias Sundries JAR/publicação 0.0.5 reconfirmado; metadata runtime físico continua 0.0.1 e a divergência permanece explicitamente documentada.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #431: JAR `ozymandias_sundries-0.0.5.jar`, mod id `ozymandias_sundries`, distribuição/version pin `0.0.5`, metadata interna `0.0.1`, SHA-1 `b973622ed90f47108aba481fec3beb19b432d853`.
