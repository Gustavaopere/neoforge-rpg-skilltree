...
- **Procedência:** modlist.txt física reconferida em 13/09/2026 + CurseForge oficial Lodestone 1.8.2 NeoForge 1.21.1, ainda a release publicada aplicável + source histórico 1.8.2 já pinado + relação de dependência de Malum 1.8.2.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Lodestone 1.8.2/JAR físico reconfirmado; 1.8.2 permanece a release NeoForge 1.21.1 mais recente publicada. Source branch mais novo não foi confundido com artefato publicado; Malum consumer, render/network/config risks e lifecycle preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #378: JAR `lodestone-1.21.1-1.8.2.jar`, mod id `lodestone`, runtime `1.8.2`, SHA-1 `d1f7c638fac5192e01b1873f27e694a3c262ad11`.
