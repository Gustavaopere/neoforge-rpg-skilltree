...
> **Registro histórico da reauditoria de 19/09/2026:** o arquivo registrava ordem #78 na contagem então usada de 586 mods top-level. A autoridade física atual está no callout acima e fixa Bosses'Rise em **#79 incluindo o modloader**. O ordinal #79 embutido em `Atualização/Status` permanece como conteúdo de paridade.
