...
O pack também contém **Immersive Furniture 0.3.3+1.21.1**. A sobreposição é majoritariamente de função decorativa/assentos e deve ser avaliada por blocos, estética, recipes e custo real; não há base para declarar duplicidade técnica integral. **\[Let's Do\] Furniture não está mais presente na modlist física atual.**
