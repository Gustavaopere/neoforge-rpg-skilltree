...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial 2.6.0/relations + source oficial Potion-Studios branch 1.21.1/changelog.
- **Atualização/Status:** REVALIDADO EM 25/09/2026 — Oh The Biomes We've Gone 2.6.0/JAR físico reconfirmado; dependências e dossiê preservados. Referência física de Oh The Trees You'll Grow atualizada para #427.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #426: JAR `Oh-The-Biomes-Weve-Gone-NeoForge-2.6.0.jar`, mod id `biomeswevegone`, runtime `2.6.0`, SHA-1 `4611dc5bb4240333178e14e81f76168f78167448`.
...
#427 é dependency obrigatória e fornece tree generation por structure templates. Isso cria uma cadeia de ownership clara:
