...
- **Dependências:** Farmer's Delight obrigatório; pack físico atual confirma Farmer's Delight 1.3.4. Compatibilidades opcionais públicas incluem Alex's Mobs, Ocean's Delight, Croptopia, Miner's Delight, Nether/End delights, Diet e Spice of Life variants conforme versão. Create: Arm-made Cuisine permanece bridge complementar quando presente.
