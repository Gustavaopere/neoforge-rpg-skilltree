...
- **Dependências:** Pack físico atual: Iron's Spells 'n Spellbooks 1.21.1-3.16.3 + Apothic Attributes 2.10.1. Source matching 1.1.9 usa Minecraft 1.21.1 e NeoForge 21.1.128 com range 21.1.0+; ISS permanece authority do casting framework.
...
- **Procedência:** modlist.txt física atual de 21/09/2026 — 587 mods incluindo o modloader — confirma `dreamless_spells-1.1.9.jar` / runtime 1.1.9 e dependencies atuais. Source público matching 1.1.9 e CurseForge oficial revalidados em 21/09/2026; 1.1.9 continua a release NeoForge 1.21.1 mais recente.
...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 21/09/2026 — lote físico #224: dreamless_spells-1.1.9.jar / runtime 1.1.9 reconfirmados como latest Release NeoForge 1.21.1; school Empty, anti-casting, attributes, material content e riscos Drained/Dullard/Counterspell permanecem atuais.
- **Decisão:** Sem decisão
