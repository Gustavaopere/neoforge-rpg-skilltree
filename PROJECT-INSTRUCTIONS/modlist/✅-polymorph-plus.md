...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial Polymorph+ 1.3.1 + documentação oficial do fork + relações oficiais Ars Polymorphia 1.0.3.
- **Atualização/Status:** REVALIDADO EM 25/09/2026 — Polymorph+ 1.3.1+1.21.1/JAR físico reconfirmado; decisão Dependência preservada.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #448: JAR `polymorph_plus-neoforge-1.3.1+1.21.1.jar`, mod id `polymorph_plus`, runtime `1.3.1+1.21.1`, SHA-1 `ec4793d7272d9b6c568119ce4f1b51e0a419b6af`.
