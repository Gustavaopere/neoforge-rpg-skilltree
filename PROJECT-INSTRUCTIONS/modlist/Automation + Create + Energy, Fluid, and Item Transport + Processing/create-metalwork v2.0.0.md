...
- **Dependências:** Create obrigatório. Pack físico usa NeoForge 21.1.248 + Create 6.0.10; Almost Unified 1.4.2 está presente e continua relevante para variant unification. Big Cannons 5.11.7, Dreams n' Desires 2.3a-BETA e Northstar 0.6.4 permanecem superfícies concretas de compatibilidade.
...
- **Procedência:** snapshot física de 11/09/2026 + runtime `createmetalwork` 2.0.0 + CurseForge oficial revalidado em 12/09/2026; 2.0.0 de 03/12/2025 continua a release NeoForge 1.21.1 mais recente. Source público antigo não é tratado como implementação binária da 2.0.0.
...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — registro histórico do lote físico #196 na snapshot então vigente; posição física atual #195: createmetalwork-2.0.0.jar / runtime 2.0.0 reconfirmados como latest Release NeoForge 1.21.1; crushed/molten ore processing, Almost Unified boundary, CBC/DnD/Northstar overlaps e Lithium crash fix permanecem atuais.
- **Decisão:** Sem decisão
