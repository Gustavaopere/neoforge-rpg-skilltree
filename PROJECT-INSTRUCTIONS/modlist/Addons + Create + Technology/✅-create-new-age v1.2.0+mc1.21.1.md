...
- **Procedência:** modlist.txt física atual de 16/09/2026 + runtime `create_new_age` 1.2.0+mc1.21.1 + CurseForge/Modrinth oficiais da release 1.2.0 e documentação já auditadas. Revalidação física/documental em 20/09/2026.
...
- **Atualização/Status:** REVALIDADO EM 20/09/2026 — registro histórico do lote físico #123 na numeração então registrada; posição física atual #124: create-new-age-1.2.0+neoforge-mc1.21.1.jar / 1.2.0+mc1.21.1 confirmados na modlist física então vigente; notas 1.2.0 de street lights, radiation/Geiger, reactor overheat e CC:Tweaked WIP permanecem registradas.
- **Decisão:** Sem decisão
