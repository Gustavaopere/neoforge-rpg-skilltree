...
- **Dependências:** Minecraft 1.21.1 + NeoForge; pack físico em NeoForge 21.1.250 + Create 6.0.10. Ponder/JEI permanecem superfícies de documentação/recipe-viewer; execução é server/Recipe Manager authoritative.
