...
- **Dependências:** NeoForge 1.21.1. JarJars internos do host: Javassist 3.30.2-GA e Mocha Floats 4.1.0; não são top-level. Nenhum consumer top-level explícito desta API foi comprovado no cruzamento atual.
...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + Modrinth/CurseForge oficiais Player Animation Library 1.1.6 + cruzamento atual do catálogo.
- **Atualização/Status:** REVALIDADO EM 25/09/2026 — Player Animation Library 1.1.6+mc.1.21.1/JAR físico reconfirmado; dossiê preservado.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #447: JAR `PlayerAnimationLibNeoforge-1.1.6+mc.1.21.1.jar`, mod id `player_animation_library`, runtime `1.1.6+mc.1.21.1`, SHA-1 `856b2e281b405dab7ca1584a7e9d053e76cc268b`.
...
### JarJars internos do host
A inspeção da modlist física confirma dois artefatos sob `META-INF/jars` dentro de Player Animation Library: `javassist-3.30.2-GA.jar` e `mochafloats-4.1.0.jar`. Eles pertencem ao host nesta instalação, não recebem ordinal/página top-level e não devem ser atualizados isoladamente sem evidência de suporte do host.
