...
- **Procedência:** modlist.txt física atual de 11/09/2026 com 595 top-levels + metadata física jar-in-jar do host (`org.sinytra.connector-2.0.0-beta.17+1.21.1-mod.jar`, mod id `connector`, runtime `2.0.0-beta.17+1.21.1`) + publicação oficial File ID 8654089 Beta 17 + documentação/FAQ/source oficiais já auditados. Reconciliação final: o host permanece `connector-2.0.0-beta.17+1.21.1-full.jar`; a ausência de metadata nas colunas top-level não foi mascarada, e a versão registrada continua sustentada pela metadata interna do próprio artefato.
...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 11/09/2026 — reconciliação final física #105: host `connector-2.0.0-beta.17+1.21.1-full.jar` reconfirmado; a linha top-level continua sem mod id/name/version, enquanto o módulo jar-in-jar `connector` declara runtime `2.0.0-beta.17+1.21.1`. Transformation/mappings/Mixins, Beta.17 deltas, cache/lifecycle e decisão `Opcional` preservados.
