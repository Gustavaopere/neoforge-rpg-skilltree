...
- **Dependências:** Create obrigatório; pack físico usa NeoForge 21.1.248 + Create 6.0.10, exatamente a linha da release 1.0.3. HeatJS não está top-level; Jade/KubeJS/CreateJS permanecem superfícies auxiliares a validar somente onde a build realmente as expõe.
