...
- **Dependências:** Epic Fight 21.17.3.1 é a dependência required. Targets são optional e ativados por presença; no pack atual estão confirmados Iron's Spells 3.16.3, Simply Swords 1.70.2, Simply More 1.3.0_alpha, Mowzie's Mobs 1.8.2, Quark 4.1-484, Supplementaries 3.9.9 e Farmer's Delight 1.3.4.
