...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#231**: JAR `dtvanillabackport-1.21.1-1.7.0.jar`, mod id `dtvanillabackport`, runtime `1.7.0`, SHA-1 `8f0bb5976d754e59ae79a6cd947051872ab415c2`.
