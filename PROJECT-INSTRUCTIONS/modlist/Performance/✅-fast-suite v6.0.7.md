...
- **Atualização/Status:** REAUDITADO EM 21/09/2026 — registro histórico do lote físico #278 na snapshot então vigente; posição física atual #279: `FastSuite-1.21.1-6.0.7.jar` / runtime `6.0.7` reconfirmados na snapshot física então vigente de 587 entradas top-level incluindo o modloader. A versão instalada não mudou nesta rodada; nenhum delta adicional de changelog foi promovido.
