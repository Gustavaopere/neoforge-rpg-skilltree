...
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + metadata runtime `immersive_portals_core` 6.0.7 + CurseForge oficial Immersive Aeronautics 1.1.4 file 8586854, Beta NeoForge 1.21.1 + changelog 1.1.4. Revalidação em 12/09/2026 não encontrou build 1.21.1 posterior.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — Immersive Aeronautics distribution 1.1.4 / runtime `immersive_portals_core` 6.0.7 reconfirmados; 1.1.4 permanece a release NeoForge 1.21.1 mais recente localizada. Dual-version authority, Sable/Create Aeronautics integration, \>5 Sable contraptions fix, DH fixes, Beta maturity, lifecycle/multiplayer, riscos e testes preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #327: arquivo físico `Immersive-Aeronautics1.1.4-1.21.1-NeoForge.jar`, mod id top-level `immersive_portals_core`, nome runtime `Immersive Portals`, runtime `6.0.7`, SHA-1 `f011404507b9790c2abfe5eb604db8056b399934`. A distribuição física é Immersive Aeronautics 1.1.4; essa dualidade de versão/nome é intencional e permanece documentada no dossiê.
