...
- **Dependências:** OBRIGATÓRIAS na source-line NeoForge 1.21.1: NeoForge, Minecraft \[1.21.1,1.22), Bookshelf \[21.1,21.2) e Prickle \[21.1,21.2), side BOTH. Pack: NeoForge 21.1.250, Bookshelf 21.1.81 e Prickle 21.1.11 — ranges satisfeitos.
...
- **Procedência:** modlist(1).txt física anexada e reconferida em 25/09/2026 + CurseForge oficial MaxHealthFix 21.1.4 NeoForge/MC 1.21.1 + source oficial branch 1.21.1 já auditada; runtime físico NeoForge 21.1.250, Bookshelf 21.1.81 e Prickle 21.1.11.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — MaxHealthFix 21.1.4/JAR físico reconfirmado no runtime NeoForge 21.1.250; Bookshelf 21.1.81 e Prickle 21.1.11 permanecem presentes e satisfazem os ranges da source-line.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #390: JAR `maxhealthfix-neoforge-1.21.1-21.1.4.jar`, mod id `maxhealthfix`, runtime `21.1.4`, SHA-1 `56243df705c150933642f7108b0d882322147d63`.
...
- **NeoForge** — build de desenvolvimento 21.1.61 como baseline da branch; o runtime físico do pack usa NeoForge 21.1.250;
...
- **Dedicated server boot:** iniciar NeoForge 21.1.250 com MaxHealthFix, Bookshelf e Prickle presentes; verificar ausência de erro de mixin/dependency.
...
- Source oficial: [Darkhax-Minecraft/Max-Health-Fix](https://github.com/Darkhax-Minecraft/Max-Health-Fix), branch `1.21.1`.
- Source-line head: [29441700803bf3044933b52d475083de50714a70](https://github.com/Darkhax-Minecraft/Max-Health-Fix/commit/29441700803bf3044933b52d475083de50714a70) — “Disable logo blur”.
- Parent imediato: [a9725ef05bd76ba55522c78629fc44f030ed5f93](https://github.com/Darkhax-Minecraft/Max-Health-Fix/commit/a9725ef05bd76ba55522c78629fc44f030ed5f93) — “Fix project validation”.
