...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial Create: Protection Pixel 2.2.1 + documentação oficial de equipamentos/sistemas.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Protection Pixel 2.2.1/JAR físico reconfirmado; integração de teste com Epic Fight/ParCool preservada.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #460: JAR `protection_pixel-2.2.1-neoforge-1.21.1.jar`, mod id `protection_pixel`, runtime `2.2.1`, SHA-1 `c35da610425f735eea4d027ad159c88de6ec6e3f`.
