...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — reconciliação final física #109: `Corgilib-NeoForge-1.21.1-5.0.0.9.jar` / `5.0.0.9` conferidos contra a modlist atual; codecs/config/data/worldgen utilities, reload/lifecycle, side, version-drift risks e consumer BWG 2.6.0 preservados.
