...
> **Autoridade física atual — 23/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#155**: JAR `create_ratatouille-1.21.1-1.4.0.jar`, mod id `ratatouille`, runtime `1.4.0`, SHA-1 `443f8625eb7df0c56bfef86f8dcc982d295f566c`.
...
- **Dependências:** Release 1.4.0 requer Farmer's Delight e Create 6.0.10+mc1.21.1. Pack físico: NeoForge 21.1.250 + Create 6.0.10 + Farmer's Delight 1.3.4.
