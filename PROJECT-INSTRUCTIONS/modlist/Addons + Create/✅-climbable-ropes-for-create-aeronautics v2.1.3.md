...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — reconciliação final física #94: `climbable_ropes-2.1.3.jar` / `2.1.3` conferidos contra a modlist atual; fixes de drift/velocity, hanging pose/FA-PE, lifecycle 2.1.1 e Player Animator 2.0.4+1.21.1 embarcado via jar-in-jar preservados.
