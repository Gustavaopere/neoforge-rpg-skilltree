...
- **Dependências:** Create obrigatório. Pack físico usa NeoForge 21.1.248 + Create 6.0.10; integrações concretas incluem Tom's Simple Storage 2.4.2, Sophisticated Core 1.5.1 e Apotheosis 8.8.0. Demais adapters continuam condicionais à presença física do provider.
