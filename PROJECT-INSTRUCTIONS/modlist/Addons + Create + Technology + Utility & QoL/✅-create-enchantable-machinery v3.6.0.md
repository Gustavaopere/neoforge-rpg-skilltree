...
- **Dependências:** Create obrigatório; pack físico usa NeoForge 21.1.248 + Create 6.0.10. Jade 15.10.6, Apotheosis 8.8.0, Apothic Enchanting 1.6.2 e Create: Enchantment Industry 2.5.3b continuam superfícies relevantes de compatibilidade/balanceamento.
