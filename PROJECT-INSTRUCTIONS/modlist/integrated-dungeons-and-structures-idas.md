...
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + CurseForge oficial IDAS 1.13.7 NeoForge 1.21.1 + documentação/changelog já auditados. O GitHub público antigo continua não sendo source authority da build atual.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — IDAS 1.13.7+1.21.1-neoforge/JAR físico reconfirmado; 1.13.7 permanece a release NeoForge 1.21.1 mais recente localizada. Dependencies, optional integrations, structure/worldgen authority, source drift, lifecycle/save risks e testes preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #321: JAR `idas-1.13.7+1.21.1-neoforge.jar`, mod id `idas`, runtime `1.13.7+1.21.1-neoforge`, SHA-1 `154f275823f5f949ed492ac6ce078a80fc3c759a`.
