...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Sable mob ragdoll corpses 1.1.5/JAR físico reconfirmado; 1.1.5 permanece a release NeoForge 1.21.1 mais recente localizada. Dossiê e decisão Manter preservados.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #399: JAR `mob_ragdoll_corpse-1.1.5.jar`, mod id `mob_ragdoll_corpse`, runtime `1.1.5`, SHA-1 `0d835a1fb2f46f544069ed39057a22305a44c2c5`.
