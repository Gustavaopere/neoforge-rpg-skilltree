...
> **Runtime físico confirmado:** `epic-fight-21.17.3.1-mc1.21.1-neoforge.jar` · mod id `epicfight` · versão `21.17.3.1` · NeoForge 1.21.1. A versão física prevalece sobre índices públicos atrasados. O changelog oficial da própria 21.17.3.1 foi revalidado em 21/09/2026 e registra uma correção ligada à integração com Simply Tooltips; os demais contratos abaixo vêm do source/docs oficiais da branch 1.21.1.
## 1. Papel no modpack
