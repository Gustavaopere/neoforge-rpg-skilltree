...
> **Autoridade física atual — 23/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#175**: JAR `createchromaticreturn-1.0.4-neoforge-1.21.1.jar`, mod id `createchromaticreturn`, runtime `1.0.0`, SHA-1 `be588d9e76ba1ce1a0556354c15fcc19d7fda133`. O filename/publicação física é `1.0.4`; a metadata/runtime top-level permanece `1.0.0`, divergência preservada para troubleshooting.
...
- **Dependências:** Página oficial 1.21.1 declara Create + Create Quality of Life + Curios; pack físico usa NeoForge 21.1.248 + Create 6.0.10 + CreateQOL 1.6.3-fix1 + Curios 9.5.1. Integrações publicadas com CC&A e Create Stuff 'N Additions têm providers instalados.
