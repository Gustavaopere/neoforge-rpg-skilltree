...
> **Reauditoria física — 18/09/2026.** Versão catalogada atual: `2101.1.36`. O conteúdo abaixo preserva a página Notion reconciliada; a URL da própria página Notion foi deliberadamente omitida.
...
- **Procedência:** modlist física atual + CurseForge oficial FTB Quests 2101.1.36, file ID 8885017, NeoForge 1.21.1, 15/09/2026.
...
- **Atualização/Status:** READITADO EM 18/09/2026 — runtime físico atualizado de 2101.1.34 para 2101.1.36; fix de permissão 2101.1.35 e hotkeys/seleção/fixes de UI 2101.1.36 incorporados.
- **Decisão:** Manter
