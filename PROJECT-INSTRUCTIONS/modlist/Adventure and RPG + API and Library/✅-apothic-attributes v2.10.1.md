...
> **Autoridade física atual — 22/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#34**: `ApothicAttributes-1.21.1-2.10.1.jar`, mod id `apothic_attributes`, runtime `2.10.1`, SHA-1 `6a6b84d09801621df5cc2c8a68f35bd93a6cda0f`.
