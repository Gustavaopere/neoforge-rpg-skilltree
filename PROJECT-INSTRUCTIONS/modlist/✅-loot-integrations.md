...
- **Procedência:** modlist.txt física reconferida em 13/09/2026 + CurseForge oficial `lootintegrations-1.21.1-4.7.jar`, ainda a release NeoForge 1.21.1 mais recente + source upstream 4.7-change já auditado, mantendo explícita a divergência de `mod_version=4.6` no Gradle do commit.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Loot Integrations 4.7/JAR físico reconfirmado; 4.7 permanece a release NeoForge 1.21.1 mais recente localizada. Datapack schema, recursion guard, weighting/fill limit, Cupboard, map fix, Lootr/LootJS coexistence e source-metadata drift preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #380: JAR `lootintegrations-1.21.1-4.7.jar`, mod id `lootintegrations`, runtime `4.7`, SHA-1 `ba601fe630f444d974838bfd80a185a0e3e0309c`.
