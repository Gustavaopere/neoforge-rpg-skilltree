...
- **Dependências:** Create 6.0.10 físico. Build 0.1.3 é Release NeoForge 1.21.1 e Client & Server; nenhuma dependência adicional obrigatória foi inferida sem metadata versionada mais granular.
