...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — reconciliação final física #115: `create-1.21.1-6.0.10.jar` / `6.0.10` conferidos contra a modlist atual; kinetic/stress authority, processing, fluids, contraptions, trains, High Logistics e inventário jar-in-jar preservados.
