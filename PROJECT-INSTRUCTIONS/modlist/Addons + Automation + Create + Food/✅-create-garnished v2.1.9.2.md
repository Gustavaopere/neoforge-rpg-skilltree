...
- **Procedência:** modlist(1).txt física atual de 22/09/2026 — 587 entradas top-level incluindo o modloader — confirma `garnished-2.1.9.2+1.21.1-neoforged.jar`, mod id `garnished`, runtime `2.1.9.2` e SHA-1 `93f86f9a2e3e23c8c20761f8d7acdd625ad49a6f`.
