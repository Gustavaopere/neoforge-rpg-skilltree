...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial Placebo 9.9.2 + consumers Apotheosis/Apothic já confirmados no catálogo.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Placebo 9.9.2/JAR físico reconfirmado; decisão Dependência preservada.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #444: JAR `Placebo-1.21.1-9.9.2.jar`, mod id `placebo`, runtime `9.9.2`, SHA-1 `d44335094cf2db64998cb3ee31e58d8c01e80b4a`.
