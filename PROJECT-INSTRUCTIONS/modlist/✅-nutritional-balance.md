...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial 7.0.3 + documentação pública de tags/datapacks/recipe traversal.
- **Atualização/Status:** REVALIDADO EM 25/09/2026 — Nutritional Balance 1.21.1-7.0.3/JAR físico reconfirmado na modlist atual; dossiê e decisão preservados.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #422: JAR `nutritionalbalance-1.21.1-7.0.3.jar`, mod id `nutritionalbalance`, runtime `1.21.1-7.0.3`, SHA-1 `f8ed8c3bfcf212e270adc9f11c4454d9c686c39f`.
