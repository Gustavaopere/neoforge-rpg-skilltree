...
- **Procedência:** modlist.txt física atual de 16/09/2026 + runtime `createutilities` 0.3.4+1.21.1 + CurseForge oficial da release + branch GitHub oficial `1.21.1` já auditado. Revalidação física/documental em 20/09/2026.
...
- **Atualização/Status:** REVALIDADO EM 20/09/2026 — registro histórico do lote físico #125 na numeração então registrada; posição física atual #126: Create-Utilities-J-1.21.1-0.3.4+1.21.1.jar / 0.3.4+1.21.1 confirmados; port NeoForge, payload API, SavedData/capabilities e fix de frequency serialization permanecem atuais.
- **Decisão:** Sem decisão
