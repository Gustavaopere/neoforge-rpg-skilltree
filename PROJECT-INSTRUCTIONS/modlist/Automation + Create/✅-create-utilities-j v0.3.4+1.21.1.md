...
- **Atualização/Status:** REVALIDADO EM 20/09/2026 — lote físico #125: Create-Utilities-J-1.21.1-0.3.4+1.21.1.jar / 0.3.4+1.21.1 confirmados; port NeoForge, payload API, SavedData/capabilities e fix de frequency serialization permanecem atuais.
- **Decisão:** Sem decisão
