...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#248**: JAR `emf_compat_create_1.21.1_2.0.0.jar`, mod id `emf_compat_create`, runtime `2.0.0`, SHA-1 `05817fa9159a0b672bfb3667ec248ae05e7a6388`.
...
## 14. Evidências
- modlist física atual: JAR/mod id/version, Create 6.0.10, Aeronautics 1.3.2 e Climbable Ropes 2.1.3;
