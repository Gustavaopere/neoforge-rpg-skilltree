...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial Patchouli 93 + relações oficiais atuais de Goety 3.1.4 e Apotheosis 8.8.0 + evidência de runtime previamente catalogada para books legacy.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Patchouli 1.21.1-93-NEOFORGE/JAR físico reconfirmado; consumers físicos Goety 3.1.4 e Apotheosis 8.8.0 permanecem confirmados.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #438: JAR `Patchouli-1.21.1-93-NEOFORGE.jar`, mod id `patchouli`, runtime `1.21.1-93-NEOFORGE`, SHA-1 `5413bb9b8fc35ebe46b06b48bf9afafbd8471140`.
