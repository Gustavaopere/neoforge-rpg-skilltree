...
- **Dependências:** Create obrigatório. Pack físico usa NeoForge 21.1.248 + Create 6.0.10 + Sable 2.0.5 + Create Aeronautics 1.3.2 + Immersive Portals 6.0.7. Waystones 21.1.44 permanece overlap de transporte, não dependência.
