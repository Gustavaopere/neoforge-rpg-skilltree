...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #264: JAR `epicfightpehkuiincompatibilityfix-1.0.2.jar`, mod id `epicfightpehkuiincompatibilityfix`, runtime `1.0.2`, SHA-1 `76eb6471698ce24d6fbdfcdd4b04397e96d401aa`.
