...
- **Dependências:** Create obrigatório. Pack físico usa NeoForge 21.1.250 + Create 6.0.10. JEI/Jade e Xaero's World Map/JourneyMap são integrações opcionais documentadas; KubeJS possui plugin dedicado; 1.3.1 adiciona compatibilidade Create Aeronautics.
