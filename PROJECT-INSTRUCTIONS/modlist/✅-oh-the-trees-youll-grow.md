...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial 5.3.2 + lineage pública 5.2–5.3 + dependency oficial de BWG.
- **Atualização/Status:** REVALIDADO EM 25/09/2026 — Oh The Trees You'll Grow 5.3.2/JAR físico reconfirmado; BWG 2.6.0 permanece consumer confirmado.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #427: JAR `Oh-The-Trees-Youll-Grow-neoforge-1.21.1-5.3.2.jar`, mod id `ohthetreesyoullgrow`, runtime `5.3.2`, SHA-1 `1867792e4e3d9fc6bb7acabb31cbec7a3d49ecad`.
