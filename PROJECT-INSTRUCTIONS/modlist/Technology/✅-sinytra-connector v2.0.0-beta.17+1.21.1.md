...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — reconciliação final física #104: host `connector-2.0.0-beta.17+1.21.1-full.jar` reconfirmado; a linha top-level continua sem mod id/name/version, enquanto o módulo jar-in-jar `connector` declara runtime `2.0.0-beta.17+1.21.1`. Transformation/mappings/Mixins, Beta.17 deltas, cache/lifecycle e decisão `Opcional` preservados.
