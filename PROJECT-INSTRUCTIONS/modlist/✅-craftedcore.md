...
- **Procedência:** modlist(1).txt física atual de 20/09/2026 + runtime 5.8.2 + CurseForge/documentação oficial CraftedCore já auditadas. Reconciliação final: JAR/runtime permanecem exatamente `craftedcore-5.8.2.jar` / `5.8.2`; sem divergência física.
...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — reconciliação final física #112: `craftedcore-5.8.2.jar` / `5.8.2` conferidos contra a modlist atual; consumer-driven library contract, shared data/resources, side/lifecycle e delta 5.8.2 preservados.
