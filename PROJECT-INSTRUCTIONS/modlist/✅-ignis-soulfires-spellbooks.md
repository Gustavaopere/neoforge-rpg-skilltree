...
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + provenance oficial 1.1.0 já auditada no catálogo + revalidação externa em 12/09/2026. Índices públicos podem exibir cache antigo da 1.0.0; por isso o JAR físico 1.1.0 e a release exata previamente verificada permanecem authority.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — Ignis Soulfires: Spellbooks 1.1.0/JAR físico reconfirmado. O JAR físico e a provenance oficial já auditada para 1.1.0 permanecem authority; nenhuma build 1.21.1 posterior foi localizada. Souled Ignitium Wizard Armor, seis dependencies, equipment/spell authority, lifecycle/multiplayer, riscos e testes preservados.
- **Data da última decisão:** 2026-08-27

> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #324: JAR `ignissoulfires_spellbooks-1.1.0.jar`, mod id `ignissoulfires_spellbooks`, runtime `1.1.0`, SHA-1 `dcde77db35b6de3562b4e6de0025746eaf68f119`.
