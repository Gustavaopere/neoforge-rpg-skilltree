...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #326: JAR `ImmediatelyFast-NeoForge-1.6.14+1.21.1.jar`, mod id `immediatelyfast`, runtime `1.6.14+1.21.1`, SHA-1 `fee59af2f39c66d09c4c09f441c799e76af70f97`. Esta é a autoridade física atual e supersede a identidade histórica 1.6.13 preservada abaixo a partir do Notion; `Reflect-1.6.2.jar` permanece dependência interna em `META-INF/jars`, não item top-level.
