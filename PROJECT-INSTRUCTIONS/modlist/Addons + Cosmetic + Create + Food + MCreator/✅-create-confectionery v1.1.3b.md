...
- **Procedência:** modlist(1).txt física atual de 20/09/2026 + metadata runtime `create_confectionery` `1.1.3.` + CurseForge/Modrinth oficiais da release NeoForge 1.21.1 `1.1.3.b` já auditados. Reconciliação final: filename `create-confectionery1.21.1_v1.1.3b.jar`, release `1.1.3.b` e runtime `1.1.3.` continuam registrados como evidências distintas, sem normalização.
...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — reconciliação final física #118: `create-confectionery1.21.1_v1.1.3b.jar` reconfirmado; runtime físico literal `1.1.3.` preservado, distinto do filename `v1.1.3b` e da release upstream `1.1.3.b`. Conteúdo/processing/lifecycle permanecem inalterados.
