...
> **Autoridade física atual — 23/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#152**: JAR `create_pattern_schematics-2.0.10.jar`, mod id `create_pattern_schematics`, runtime `2.0.10`, SHA-1 `e3dea574c3b3d590444796a42e8f7456280b1063`.
...
- **Dependências:** Create obrigatório. Release 2.0.10 é NeoForge 1.21.1, Client & Server; changelog fixa compatibilidade com Create 6.0.7. O pack físico usa NeoForge 21.1.250 + Create 6.0.10.
