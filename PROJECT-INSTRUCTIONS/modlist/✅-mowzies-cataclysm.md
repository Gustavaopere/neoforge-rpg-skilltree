...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Mowzie's Cataclysm 1.2.2 continua sendo a release NeoForge 1.21.1 mais recente localizada; source indisponível e boundaries preservados.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #410: JAR `mowzies_cataclysm-1.2.2.jar`, mod id `mowzies_cataclysm`, runtime `1.2.2`, SHA-1 `0dff3e849155ca343d1a500f5b9ca2b54ffa692d`.
...
- **L_Ender's Cataclysm**;
- **Mowzie's Mobs**.
Ambos os providers estão presentes no pack. #411 é Mowzie's Mobs 1.8.2; Cataclysm e vários addons/bridges de Cataclysm também aparecem fisicamente na modlist.
