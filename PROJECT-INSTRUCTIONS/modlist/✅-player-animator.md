...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial Player Animator 2.0.4 + relação oficial já auditada de Create: Gunsmithing 1.4.9.
- **Atualização/Status:** REVALIDADO EM 25/09/2026 — Player Animator 2.0.4+1.21.1/JAR físico reconfirmado; canal Beta e decisão Dependência preservados.
...
> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #446: JAR `player-animation-lib-forge-2.0.4+1.21.1.jar`, mod id `playeranimator`, runtime `2.0.4+1.21.1`, SHA-1 `05be8ddcc78532b9a5520c718edc6c971cd0057c`.
