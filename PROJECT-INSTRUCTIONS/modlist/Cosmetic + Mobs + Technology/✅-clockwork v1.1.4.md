...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — reconciliação final física #95: `clockwork-neoforge-1.21.1-1.1.4.jar` / `1.1.4` conferidos contra a modlist atual; Dragonfly, crossbows, Potion Sprayer, Wings, Flamethrower, Drill, configs/lifecycle e decisão `Manter` preservados. Release 1.1.5 posterior existe, mas não substitui a autoridade do JAR físico instalado.
