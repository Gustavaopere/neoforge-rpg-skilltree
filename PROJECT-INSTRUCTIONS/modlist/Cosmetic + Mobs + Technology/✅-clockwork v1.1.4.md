...
- **Procedência:** modlist(1).txt física atual de 20/09/2026 + CurseForge oficial Clockwork 1.1.4 e changelog exato já auditado. Reconciliação final: JAR/runtime instalados permanecem exatamente `clockwork-neoforge-1.21.1-1.1.4.jar` / `1.1.4`; decisão `Manter` permanece inalterada e o mod continua distinguido do antigo projeto Create: Clockwork. A existência posterior da release 1.1.5 não altera a versão física auditada.
...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — registro histórico da reconciliação física #95 na numeração então registrada; posição física atual #96: `clockwork-neoforge-1.21.1-1.1.4.jar` / `1.1.4` conferidos contra a modlist então vigente; Dragonfly, crossbows, Potion Sprayer, Wings, Flamethrower, Drill, configs/lifecycle e decisão `Manter` preservados. Release 1.1.5 posterior existe, mas não substitui a autoridade do JAR físico instalado.
