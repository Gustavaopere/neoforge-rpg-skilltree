...
- **Arquivo JAR:** `EclipticSeasons-1.21.1-neoforge-0.15.0-rc-3-1.jar`
- **Versão 1.21.1:** `0.15.0-rc-3-1`
...
> **Runtime físico confirmado:** `EclipticSeasons-1.21.1-neoforge-0.15.0-rc-3-1.jar` · mod id `eclipticseasons` · versão `0.15.0-rc-3-1` · NeoForge 1.21.1 · canal oficial Beta/RC.
## 1. Papel no modpack
...
**Build física atual:** o pack usa `EclipticSeasons-1.21.1-neoforge-0.15.0-rc-3-1.jar` (File ID 8849038), publicado em 10/09/2026. A página oficial desse arquivo declara **“File has no changelog”**; portanto a reauditoria apenas reconcilia a identidade da build atual e não atribui a ela fixes ou mudanças funcionais não documentadas.
...
## 19. Evidências
- modlist física atual de 21/09/2026: `EclipticSeasons-1.21.1-neoforge-0.15.0-rc-3-1.jar`, mod id `eclipticseasons`, runtime `0.15.0-rc-3-1`;
