...
- **Atualização/Status:** REVALIDADO EM 20/09/2026 — lote físico #123: create-new-age-1.2.0+neoforge-mc1.21.1.jar / 1.2.0+mc1.21.1 confirmados na modlist física atual; notas 1.2.0 de street lights, radiation/Geiger, reactor overheat e CC:Tweaked WIP permanecem registradas.
- **Decisão:** Sem decisão
