...
- **Procedência:** modlist(1).txt física anexada e reconferida em 25/09/2026 + CurseForge oficial MineColonies: Jade crops + source oficial exato 1.1.1300 já auditado; runtime físico atual NeoForge 21.1.250, MineColonies 1.1.1387 e Jade 15.10.6+neoforge.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — MineColonies: Jade crops 1.1.1300/JAR físico reconfirmado; runtime atual reconciliado com NeoForge 21.1.250, MineColonies 1.1.1387 e Jade 15.10.6+neoforge. Provider Jade, namespace+`age`, config e client-only boundary preservados; smoke test de schema continua obrigatório.
- **Histórico da decisão:** 2026-09-07 — novo mod incorporado à auditoria; sem decisão curatorial ainda.
- **Data da última decisão:** 2026-09-07

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #391: JAR `mcjadecrops-1.1.1300.jar`, mod id `mcjadecrops`, runtime `1.1.1300`, SHA-1 `5afb193b78d8cae863e74c61ce057c08410e67cb`.

<callout icon="🌱" color="green_bg">
	**ESCOPO CANÔNICO.** Runtime físico: `mcjadecrops-1.1.1300.jar`, mod id `mcjadecrops`, versão `1.1.1300`, em NeoForge 21.1.250 / Minecraft 1.21.1. O source público `alexkond12/MineColonies-Jade-crops` declara exatamente `mod_version=1.1.1300`, Minecraft 1.21.1 e NeoForge mínimo 21.1.227; por isso a implementação abaixo é tratada como correspondência direta da build instalada.
</callout>
...
O pack físico contém MineColonies 1.1.1387 e Jade 15.10.6+neoforge; a versão do addon continua 1.1.1300. A lógica por namespace/property reduz acoplamento a IDs concretos, mas não elimina risco de mudança de schema.
...
- **MineColonies 1.1.1387:** provider dos crops; está mais novo que o número embutido no nome/release do addon, exigindo smoke test de properties.
...
## 11. Matriz de testes
- [ ] Dedicated server + cliente iniciam com NeoForge 21.1.250, MineColonies 1.1.1387 e Jade 15.10.6+neoforge.
