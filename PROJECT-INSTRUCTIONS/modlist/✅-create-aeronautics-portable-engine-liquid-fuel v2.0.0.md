...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial do projeto/release 2.0.0 + documentação oficial de datapack/data maps para fuels.
- **Atualização/Status:** REVALIDADO EM 25/09/2026 — Create Aeronautics: Portable Engine Liquid Fuel 2.0.0/JAR físico reconfirmado; dossiê preservado.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #451: JAR `portable_engine_liquid_fuel-2.0.0-neoforge-1.21.1.jar`, mod id `portable_engine_liquid_fuel`, runtime `2.0.0`, SHA-1 `f9602c7f9a8268507a835bfa47db1512d356dae7`.
