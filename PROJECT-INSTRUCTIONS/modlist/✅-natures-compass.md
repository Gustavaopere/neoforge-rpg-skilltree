...
- **Procedência:** modlist.txt física reconferida em 13/09/2026 + CurseForge oficial confirmando `NaturesCompass-1.21.1-3.4.0-neoforge.jar` como release NeoForge 1.21.1 mais recente localizada + changelog já auditado.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Nature's Compass 1.21.1-3.4.0-neoforge/JAR físico reconfirmado; 3.4.0 permanece a release NeoForge 1.21.1 mais recente localizada. Dossiê e decisão Sem decisão preservados.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #415: JAR `NaturesCompass-1.21.1-3.4.0-neoforge.jar`, mod id `naturescompass`, runtime `1.21.1-3.4.0-neoforge`, SHA-1 `e19721873bebc4dbc1674bb101af39d0ea406b95`.
