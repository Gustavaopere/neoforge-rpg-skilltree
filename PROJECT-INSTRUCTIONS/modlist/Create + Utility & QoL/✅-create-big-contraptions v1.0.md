...
> **Registro histórico da reauditoria de 19/09/2026:** o arquivo registrava ordem #74 na contagem então usada de 586 mods top-level. A autoridade física atual está no callout acima e fixa Create: Big Contraptions em **#75 incluindo o modloader**. O ordinal #75 embutido em `Atualização/Status` permanece como conteúdo de paridade.
