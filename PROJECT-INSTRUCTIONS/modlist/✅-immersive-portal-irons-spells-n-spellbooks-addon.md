...
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + release oficial 1.0.1/file 8770439 já auditada no catálogo + GitHub oficial usado apenas estruturalmente por permanecer em mod_version 1.0.0 + revalidação externa em 12/09/2026. O JAR físico 1.0.1 continua authority quando índices públicos exibem cache antigo.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — Immersive Portal - Iron's Spells 'n Spellbooks Addon 1.0.1/JAR físico reconfirmado. A matriz atual continua Iron's 3.16.3 + `immersive_portals_core` 6.0.7 fornecido por Immersive Aeronautics 1.1.4; nenhuma build 1.21.1 posterior foi localizada. Source drift 1.0.0→1.0.1 e lifecycle do Portal Spell preservados.
- **Data da última decisão:** 2026-09-06

> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #329: JAR `immersive_portal_irons_spells_n_spellbooks_addon-1.0.1.jar`, mod id `immersive_portal_irons_spells_n_spellbooks_addon`, runtime `1.0.1`, SHA-1 `ebfd9e75b591cf3fd250dbcdd219706b6afb96f1`.
