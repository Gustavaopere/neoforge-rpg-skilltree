...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial Presence Footsteps x Sable 1.0 + presença física dos três sistemas envolvidos.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Presence Footsteps x Sable 1.0/JAR físico reconfirmado; Presence Footsteps 1.12.0-beta.1 e prerequisites funcionais permanecem presentes.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #441: JAR `pfsable-1.0.jar`, mod id `pfsable`, runtime `1.0`, SHA-1 `a216dfce15550c50436012283e49606c67a87e29`.
