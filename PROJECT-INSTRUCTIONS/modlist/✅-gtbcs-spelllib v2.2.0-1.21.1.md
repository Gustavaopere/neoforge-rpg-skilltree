...
- **Procedência:** modlist(1).txt física atual de 22/09/2026 — 587 entradas top-level incluindo o modloader — confirma `gtbcs_spell_lib-2.2.0-1.21.1.jar`, mod id `gtbcs_spell_lib`, runtime `2.2.0-1.21.1` e SHA-1 `36cce8ab3117e89ae992a84a566d596709db2ffe`. CurseForge oficial revalidado em 22/09/2026 mantém 2.2.0 como release NeoForge 1.21.1 atual; source público exato continua não localizado e internals não publicados permanecem fail-closed.
