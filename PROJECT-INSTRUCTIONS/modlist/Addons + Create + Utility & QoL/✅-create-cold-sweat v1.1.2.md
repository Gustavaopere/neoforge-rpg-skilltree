...
> 🌡️ **ESCOPO CANÔNICO.** Runtime físico `create_cold_sweat-1.1.2.jar`. A bridge conecta Create 6.0.10 a Cold Sweat 2.4.3.1 para tratar temperaturas de fluidos e interações térmicas de objetos Create que datapacks/KubeJS isolados não modelam completamente.
...
## 11. Matriz de testes
- [ ] Dedicated server inicia com CCS 1.1.2 + Create 6.0.10 + Cold Sweat 2.4.3.1.
