...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #273: JAR `familiarslib-1.21.1-1.7.1.jar`, mod id `familiarslib`, runtime `1.21.1-1.7`, SHA-1 `7fa3f3116e35c12456425ae195924ced33fcc2eb`.
...
A release física **1.7.1** corrige especificamente o caso em que familiar beds não estavam efetivamente curando familiars. Esse comportamento entra como regression gate da versão instalada.
Regression gates: save/reload, block break, chunk unload, acesso concorrente ao storage, cura do familiar e remoção/invalidação de familiar associado.
...
O `gradle.properties` do source 1.21.1 declara Minecraft 1.21.1, NeoForge 21.1.90, Iron's Spells 3.15.5, GeckoLib 4.7.5.1, Curios 9.2.2 e Player Animator 2.0.1 como baseline de desenvolvimento. O pack físico atual usa Iron's Spells 3.16.3, GeckoLib 4.9.2, Curios 9.5.1+1.21.1 e Player Animator 2.0.4+1.21.1.
...
## 15. Evidências
- modlist física canônica de 21/09/2026: JAR, mod id, metadata version, hash e versões atuais dos providers relevantes;
