...
- **Atualização/Status:** REAUDITADO EM 21/09/2026 — registro histórico do lote físico #260 na snapshot então vigente; posição física atual #261: `epic_api-21.3.1.jar` / runtime `21.3.1` reconfirmados na snapshot física então vigente de 587 entradas top-level incluindo o modloader. CurseForge oficial mantém 21.3.1 como latest release NeoForge 1.21.1; source/runtime continuam alinhados.
- **Decisão:** Sem decisão
