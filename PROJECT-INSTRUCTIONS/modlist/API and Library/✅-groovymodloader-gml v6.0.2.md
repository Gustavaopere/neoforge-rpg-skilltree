...
- **Procedência:** modlist(1).txt física atual de 22/09/2026 — 587 entradas top-level incluindo o modloader — confirma `gml-6.0.2.jar`, mod id `gml`, runtime `6.0.2` e SHA-1 `29a8153c54b9b03a3b4b42be7d77fe4ac2459720`. CurseForge oficial revalidado em 22/09/2026 mantém 6.0.2 como release NeoForge 1.21.1 atual.
