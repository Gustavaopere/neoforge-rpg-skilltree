...
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + CurseForge oficial Iceberg 1.3.2 NeoForge 1.21.1 + source oficial AHilyard/Iceberg branch 1.21.1-multi exatamente em 1.3.2 + revalidação de versões em 12/09/2026; linhas 1.4.x observadas são para Minecraft 26.x.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — Iceberg 1.3.2/JAR físicos reconfirmados; 1.3.2 permanece a build NeoForge aplicável localizada para Minecraft 1.21.1. Releases 1.4.x observadas pertencem à linha Minecraft 26.x e não substituem a matriz atual; arquitetura common/platform, tooltip/config boundaries, lifecycle, riscos e testes preservados.
