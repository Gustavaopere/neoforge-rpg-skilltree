...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — reconciliação final física #105: `ConnectorExtras-1.12.1+1.21.1.jar` / `1.12.1+1.21.1` conferidos contra a modlist atual; bridges de energia/recipe viewers/config/TerraBlender, módulos jar-in-jar, lifecycle e decisão `Opcional` preservados.
