...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — reconciliação final física #88: `cbc_at_Neoforge_1.21.1_0.1.4c.jar` / `0.1.4c-1.21.1` conferidos contra a modlist atual; 110-block release scope, cannon/ammunition families, CBC 5.11.3→pack 5.11.7 drift e CBCAT Fix top-level separado preservados.
