...
- **Procedência:** modlist(1).txt física atual de 20/09/2026 + CurseForge/Modrinth oficiais CBC: Advanced Technologies 0.1.4c + descrição/changelog oficiais + Create 6.0.10 e Create Big Cannons 5.11.7 físicos e fontes já auditadas. Reconciliação final: JAR/runtime permanecem exatamente `cbc_at_Neoforge_1.21.1_0.1.4c.jar` / `0.1.4c-1.21.1`; drift CBC 5.11.3→5.11.7 permanece como gate de QA, não divergência física.
...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 20/09/2026 — registro histórico da reconciliação física #88 na snapshot então vigente; posição física atual #89: `cbc_at_Neoforge_1.21.1_0.1.4c.jar` / `0.1.4c-1.21.1` conferidos contra a snapshot então vigente; 110-block release scope, cannon/ammunition families, CBC 5.11.3→pack 5.11.7 drift e CBCAT Fix top-level separado preservados.
