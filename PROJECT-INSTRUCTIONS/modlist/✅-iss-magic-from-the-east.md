...
- **Observações:** 1.1.5 continua a release atual para Minecraft 1.21.1. A atualização recente da página/projeto não foi interpretada como nova versão binária. Drift documentado com Iron's source 3.16.2 versus core físico 3.16.3 permanece regression gate.
- **Procedência:** modlist.txt física anexada e reconferida em 12/09/2026 + Modrinth oficial Magic From The East 1.1.5 para NeoForge 1.21.1 + source oficial commit `13208302…` e changelog já auditados. A página do projeto recebeu atualização recente, mas a listagem continua sem release 1.21.1 posterior à 1.1.5.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 12/09/2026 — ISS: Magic From The East 1.1.5/JAR físico reconfirmado; 1.1.5 permanece a release NeoForge 1.21.1 mais recente localizada. Registry exato 22 spells, equipment/effects/Jiangshi/Jadestone/worldgen/config, static QA divergences, Iron's 3.16.2→3.16.3 drift, lifecycle, riscos e testes preservados.
- **Data da última decisão:** 2026-08-26

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #346: JAR `iss_magicfromtheeast-1.1.5.jar`, mod id `iss_magicfromtheeast`, runtime `1.1.5`, SHA-1 `e3552ea6b7b32b843c48bf0d857237d4b7129ab0`.
