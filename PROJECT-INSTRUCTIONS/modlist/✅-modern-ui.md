...
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 13/09/2026 — Modern UI 3.13.0.1 permanece a release NeoForge 1.21.1 mais recente localizada; dossiê e JarJars internos preservados.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #403: JAR `ModernUI-NeoForge-1.21.1-3.13.0.1-universal.jar`, mod id `modernui`, runtime `3.13.0.1`, SHA-1 `d6dc4131595f6b38274e5c16ef13895ab2125010`.
