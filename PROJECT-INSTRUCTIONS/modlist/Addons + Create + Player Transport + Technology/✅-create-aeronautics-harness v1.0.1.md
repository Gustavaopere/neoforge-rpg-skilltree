...
- **Dependências:** Pack físico: NeoForge 21.1.250 + Create 6.0.10 + Create Aeronautics 1.3.2 + Sable 2.0.5. Create Big Cannons 5.11.7 integra concretamente com Harness 1.0.1; source matching exige Aeronautics 1.3.0+.
