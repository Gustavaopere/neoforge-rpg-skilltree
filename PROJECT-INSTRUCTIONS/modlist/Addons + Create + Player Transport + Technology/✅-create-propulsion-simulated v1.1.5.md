...
> **Autoridade física atual — 24/09/2026.** `modlist(1).txt` contém **587 entradas top-level incluindo o modloader**; este item ocupa a ordem física **#200**: JAR `createpropulsion-1.1.5.jar`, mod id `createpropulsion`, runtime `1.1.5`, SHA-1 `928e9428ee92d07426c296b04a7fffb1e737e290`.
...
- **Dependências:** Pack físico: NeoForge 21.1.248 + Create 6.0.10 + Sable 2.0.5 + Create Aeronautics 1.3.2. Source matching 1.1.5 usa Create 6.0.10 e Sable 2.0.3; TFMG, CC&A, Create Diesel Generators e Northstar permanecem providers condicionais de combustível/energia.
