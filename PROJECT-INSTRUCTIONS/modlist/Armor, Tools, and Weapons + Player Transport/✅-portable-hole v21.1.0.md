...
- **Procedência:** modlist(1).txt física reconferida em 25/09/2026 + CurseForge oficial Portable Hole 21.1.0 + documentação oficial de mecânica/configuração.
- **Atualização/Status:** PADRÃO ALEX'S MOBS REVALIDADO EM 25/09/2026 — Portable Hole 21.1.0/JAR físico reconfirmado; Puzzles Lib 21.1.60 permanece presente como dependência NeoForge; restauração temporária e lifecycle risks preservados.
- **Histórico da decisão:** 
- **Data da última decisão:** 2026-09-10

> **Autoridade física atual — 25/09/2026.** `modlist(1).txt` contém 587 entradas top-level incluindo o modloader; este item ocupa a ordem física #452: JAR `PortableHole-v21.1.0-1.21.1-NeoForge.jar`, mod id `portablehole`, runtime `21.1.0`, SHA-1 `dd651e3c3b15496112ba2bcc3cdce7bf89d3ed85`.
