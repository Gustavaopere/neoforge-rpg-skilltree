...
- **Procedência:** captura física Shaders de 08/09/2026 (r5.9) + modlist física de 16/09/2026 (Iris 1.8.14-beta.1 e Euphoria Patcher 1.10.5-r5.9.3) + CurseForge oficial Complementary Reimagined r5.9.3 de 15/09/2026, rechecado em 20/09/2026. A versão instalada do ZIP shader permanece não confirmada após 08/09.
- **Observações:** Última captura física disponível: `ComplementaryReimagined_r5.9.zip` em 08/09/2026. O upstream foi rechecado em 20/09/2026 e continua em r5.9.3, publicado em 15/09/2026. Como o stack atual já usa Euphoria Patcher 1.10.5-r5.9.3 e não há inventário posterior do diretório shaderpacks, o runtime exato do shader está pendente de confirmação física.
- **Atualização/Status:** REVALIDAÇÃO BLOQUEADA EM 20/09/2026 — a última captura física disponível confirma ComplementaryReimagined_[r5.9.zip](http://r5.9.zip), enquanto o upstream rechecado continua em Complementary Reimagined r5.9.3, publicado em 15/09/2026, e a modlist física de 16/09/2026 usa Euphoria Patcher 1.10.5-r5.9.3-neoforge. Sem inventário físico atual do diretório shaderpacks, a versão exata instalada do shader permanece não resolvida e não pode receber certificação.
- **Decisão:** Sem decisão
