...
final class CompendiumCheckedInEditorialBatch14JUnitTest {
    private static final String CLASSPATH_RESOURCE =
        "/data/rpgskilltree/compendium/editorial/pt_br/biomeswevegone/biomes-batch3.json";
    private static final ResourceLocation EDITORIAL_RESOURCE = ResourceLocation.parse(
        "rpgskilltree:compendium/editorial/pt_br/biomeswevegone/biomes-batch3.json"
    );
    private static final Set<String> EXPECTED_IDS = Set.of(
        "BIOME:biomeswevegone:ebony_woods",
        "BIOME:biomeswevegone:enchanted_tangle",
        "BIOME:biomeswevegone:eroded_borealis",
        "BIOME:biomeswevegone:firecracker_chaparral",
        "BIOME:biomeswevegone:forgotten_forest",
        "BIOME:biomeswevegone:fragment_jungle",
        "BIOME:biomeswevegone:frosted_coniferous_forest",
        "BIOME:biomeswevegone:frosted_taiga",
        "BIOME:biomeswevegone:howling_peaks",
        "BIOME:biomeswevegone:ironwood_gour"
    );

    @Test
    void thirdBwgBiomeBatchIsCheckedInReviewedAndLoadable() throws Exception {
        JsonObject pack;
        try (InputStream input = getClass().getResourceAsStream(CLASSPATH_RESOURCE)) {
            assertNotNull(input, "Stage 10.10 must ship the third reviewed pt-BR BWG biome package");
