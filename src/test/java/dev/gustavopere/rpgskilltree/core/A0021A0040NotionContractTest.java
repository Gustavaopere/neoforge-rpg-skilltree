...
public final class A0021A0040NotionContractTest {
    ...
    private static void ranksCostsDependenciesMatchFreshNotion() {
        expect("A0021",3,1,Map.of("A0019",1)); expect("A0022",2,1,Map.of("A0021",2));
        expect("A0023",2,1,Map.of("A0020",2,"A0021",1)); expect("A0024",1,2,Map.of("A0022",1,"A0023",1));
        expect("A0025",3,1,Map.of()); expect("A0026",3,1,Map.of("A0025",2)); expect("A0027",3,1,Map.of("A0025",1));
        expect("A0028",2,1,Map.of("A0027",2)); expect("A0029",2,1,Map.of("A0026",2,"A0027",1)); expect("A0030",1,2,Map.of("A0028",1,"A0029",1));
        expect("A0031",3,1,Map.of()); expect("A0032",3,1,Map.of("A0031",2)); expect("A0033",3,1,Map.of("A0031",1));
        expect("A0034",2,1,Map.of("A0033",2)); expect("A0035",2,1,Map.of("A0032",2,"A0033",1)); expect("A0036",1,2,Map.of("A0034",1,"A0035",1));
        expect("A0037",3,1,Map.of()); expect("A0038",3,1,Map.of("A0037",2)); expect("A0039",3,1,Map.of("A0037",1)); expect("A0040",2,1,Map.of("A0039",2));
    }

    private static void familiesAndGatesMatchFreshNotion() {
        family("A0021","DAGGER"); family("A0024","DAGGER"); family("A0025","HAMMER"); family("A0030","HAMMER");
    ...
    private static void expect(String code, int maxRank, int cost, Map<String,Integer> dependencies) {
        ...
        require(d.maxRank()==maxRank, code+" maxRank"); require(d.rankCost()==cost, code+" rankCost");
