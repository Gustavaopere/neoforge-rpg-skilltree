...
public final class CanonicalStatCatalog {
 ...
 public static CanonicalStatCatalog defaults(){
  ...
  for(String id:List.of("scythe_proficiency","spirit_spoils","arcane_resonance","soul_ward_integrity","soul_ward_recovery_rate","soul_ward_recovery_gain","soul_ward_capacity","charge_duration","charge_capacity","charge_recovery_rate","geas_limit","malignant_conversion","malignant_aegis_recovery_rate","malignant_aegis_recovery_gain","malignant_aegis_capacity")) s.add(stat("malum:"+id));
