...
/** Immutable definition for the CHAT 1-closed A0001-A0020 combat catalog. */
public record CombatPerkDefinition(
    ...
    public CombatPerkDefinition {
        ...
        if (!code.matches("A00(?:0[1-9]|1[0-9]|20)")) {
            throw new IllegalArgumentException("catalog code outside A0001-A0020: " + code);
        }
    ...
    public enum WeaponFamily { SWORD, AXE, SPEAR, DAGGER }
