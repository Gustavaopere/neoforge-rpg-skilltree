...
public final class FoodRelationProvider {
    private FoodRelationProvider() {}
    ...
    public static List<CompendiumRelation> relations(
        ...
        for (CompendiumRelationTarget target : targets == null ? List.<CompendiumRelationTarget>of() : targets) {
            relations.add(new CompendiumRelation(CompendiumRelationType.EATS, target, source, confidence, evidenceId));
        }
