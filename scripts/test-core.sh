...
java -cp "$OUT" dev.gustavopere.rpgskilltree.core.CombatPerkHeavyImpactConsumerPolicyTest
java -cp "$OUT" dev.gustavopere.rpgskilltree.core.FrozenA0004MomentumPolicyTest
java -cp "$OUT" dev.gustavopere.rpgskilltree.core.FrozenA0016DistanceControlCycleTest
java -cp "$OUT" dev.gustavopere.rpgskilltree.core.FrozenA0022FlowCycleTest
...
java -cp "$OUT" dev.gustavopere.rpgskilltree.core.FrozenA0005GateLifecycleTest
java -cp "$OUT" dev.gustavopere.rpgskilltree.core.FrozenA0023PositionContractTest
java -cp "$OUT" dev.gustavopere.rpgskilltree.core.FrozenCombatGatewayLifecycleTest
java -cp "$OUT" dev.gustavopere.rpgskilltree.core.FrozenProviderBoundaryContractTest
java -cp "$OUT" dev.gustavopere.rpgskilltree.core.MigratedA0001A0050ProviderContractTest
