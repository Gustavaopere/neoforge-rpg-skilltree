...
require_contains('src/main/java/dev/gustavopere/rpgskilltree/runtime/FrozenSurvivalRuntimeState.java',
                 ...
                 'EquipmentConservationService',
                 'CanonicalMaintenanceService',
                 'FieldReinforcementService',
                 'BodyCostResolver',
                 'TfcExhaustionHydrationLedger',
                 'AcclimationLedger',
                 'PhysiologicalRestService',
                 'NutritionQualityResolver',
                 'MagicPowerResolver',
                 'SpellRecoveryService',
                 'ResourceDebitReceiptService',
                 'CastingStabilityService',
                 'FrozenSurvivalPerkNodeBinding.ranks',
                 'rpgskilltree.a0101_a0150.acclimation_hot',
                 'rpgskilltree.a0101_a0150.acclimation_cold',
                 'observeThermalState',
                 'recordHostileCombat',
                 'clearTransient')
require_contains('src/main/java/dev/gustavopere/rpgskilltree/runtime/events/FrozenSurvivalEvents.java',
                 ...
                 'FrozenSurvivalRuntimeState.recordHostileCombat',
                 'FakePlayer')
require_contains('src/main/java/dev/gustavopere/rpgskilltree/runtime/events/PlayerProgressionEvents.java',
