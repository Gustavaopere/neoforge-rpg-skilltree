...
for needle in (
    "public static CoreProgressionState applyFirstCompletionXp(",
    "current.progressionRewardClaims().isCompletionClaimed(completionKey)",
    "CoreProgressionMutationService.grantXp(",
