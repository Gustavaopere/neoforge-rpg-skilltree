...
Usar `historia/templates/TEMPLATE-DIALOGO.md` enquanto Markdown for suficiente. Um framework como Ink só substitui o formato editorial após PoC e adapter explícitos.
